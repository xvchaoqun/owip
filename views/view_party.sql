...
SELECT opp.*,op.sort_order as party_sort_order,ob.sort_order as branch_sort_order
...
SELECT opr.*,op.sort_order as party_sort_order,ob.sort_order as branch_sort_order
