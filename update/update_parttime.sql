...
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5009, 0, '审批权限管理', '', 'url', '', '/parttimeApproveAuth', 5007, '0/1/5007/', 1, 'parttimeApproveAuth:*', 4, NULL, NULL, 1, NULL);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5010, 0, '兼职申报管理员', '', 'function', '', NULL, 5007, '0/1/5007/', 1, 'parttime:companyApply', 2, NULL, NULL, 1, NULL);
