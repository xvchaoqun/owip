...
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5007, 0, '干部兼职申报', '', 'menu', 'fa fa-random', NULL, 1, '0/1/', 0, 'parttimeApply:menu', 4, NULL, NULL, 1, 5390);
