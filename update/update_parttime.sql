...
replace INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5007, 0, '干部兼职申报', '', 'menu', 'fa fa-random', NULL, 1, '0/1/', 0, 'parttimeApply:menu', 4, NULL, NULL, 1, 5390);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5008, 0, '兼职申报审批(管理员)', '', 'url', '', '/parttime/parttimeApply_page', 5007, '0/1/5007/', 1, 'parttimeApply:list', 4, NULL, NULL, 1, 600);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5009, 0, '审批权限管理', '', 'url', '', '/parttimeApproveAuth', 5007, '0/1/5007/', 1, 'parttimeApply:approveAuth', 4, NULL, NULL, 1, 500);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5010, 0, '兼职申报管理员', '', 'function', '', NULL, 5015, '0/1/5007/5015/', 1, 'parttimeApply:*', 2, NULL, NULL, 1, NULL);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5011, 0, '兼职申报审批', '', 'url', '', '/parttime/parttimeApplyList', 5007, '0/1/5007/', 1, 'parttimeApply:approvalList', 4, NULL, NULL, 1, NULL);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5013, 0, '兼职申报申请', '', 'url', '', '/user/parttime/parttimeApply', 5007, '0/1/5007/', 1, 'userParttimeApply:*', NULL, NULL, NULL, 1, 400);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5015, 0, '干部兼职申报审批功能', '', 'function', '', NULL, 5007, '0/1/5007/', 0, 'parttimeApply:function', NULL, NULL, NULL, 1, NULL);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5014, 0, '申报详情', '', 'function', '', NULL, 5015, '0/1/5007/5015/', 1, 'parttimeApply:view', NULL, NULL, NULL, 1, NULL);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (5017, 0, '审批', '', 'function', '', NULL, 5015, '0/1/5007/5015/', 1, 'parttimeApply:approve', NULL, NULL, NULL, 1, NULL);
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (1250, 0, '申报管理', '', 'function', '', NULL, 5015, '0/1/5007/5015/', 1, 'parttimeApply:admin', NULL, NULL, NULL, 1, NULL);
