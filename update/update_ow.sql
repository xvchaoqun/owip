-- 2021.5.7 ly
INSERT INTO `sys_resource` (`id`, `is_mobile`, `name`, `remark`, `type`, `menu_css`, `url`, `parent_id`, `parent_ids`, `is_leaf`, `permission`, `role_count`, `count_cache_keys`, `count_cache_roles`, `available`, `sort_order`) VALUES (2636, 0, '控制部分内容显示', '', 'function', '', NULL, 312, '0/1/108/312/', 1, 'statOw:showPart', NULL, NULL, NULL, 1, NULL);
