...
CREATE TABLE `qy_reward_obj` (
	`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id',
	`record_id` INT(10) UNSIGNED NULL DEFAULT NULL COMMENT '获奖记录id',
	...
	PRIMARY KEY (`id`),
	INDEX `FK_qy_reward_obj_qy_reward_record` (`record_id`),
...
CREATE TABLE `qy_reward_record` (
	`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id',
	`year_reward_id` INT(10) UNSIGNED NULL DEFAULT NULL COMMENT '年度奖项id',
	`remark` VARCHAR(200) NULL DEFAULT NULL COMMENT '备注',
	PRIMARY KEY (`id`),
	INDEX `FK_qy_reward_record_qy_year_reward` (`year_reward_id`),
...
CREATE TABLE `qy_year_reward` (
	...
	`remark` VARCHAR(200) NULL DEFAULT NULL COMMENT '备注',
	PRIMARY KEY (`id`),
	UNIQUE INDEX `year_id_reward_id` (`year_id`, `reward_id`),
	INDEX `FK_qy_year_reward_qy_reward` (`reward_id`),
