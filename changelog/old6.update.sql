...
UPDATE `base_meta_class` SET `name`='组织类型' WHERE  `id`=19;
UPDATE `base_meta_class` SET `name`='党总支类别' WHERE  `id`=20;
UPDATE `base_meta_class` SET `name`='所在单位属性' WHERE  `id`=21;
UPDATE `base_meta_class` SET `first_level`='党组织机构管理' WHERE  `id`=21;
UPDATE `base_meta_class` SET `second_level`='基层党组织' WHERE  `id`=21;
