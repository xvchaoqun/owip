...
#提前“前后”两个版本之间变更的文件
git diff --diff-filter=d 7a378b5474a66c1cb2647acc9b1ca85fa4f495bd 88a961d47f475f6002fd1616e30e158bde224bf9 --name-only | xargs tar -cf /cygdrive/d/tmp/diff.zip
