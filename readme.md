...
#提前“前后”两个版本之间变更的文件
git diff --diff-filter=d 7f421da7c5ff16d3453dbc3c29ce19a2893a376e 9362d5cfaf196c7d3ac3062ae99735951305d646 --name-only | xargs tar -cf /cygdrive/d/tmp/diff.zip
