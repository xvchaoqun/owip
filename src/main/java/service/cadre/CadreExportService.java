...
public class CadreExportService extends BaseMapper {
    ...
    public List<String> getTitles(){
        ...
        return new ArrayList<>(Arrays.asList(new String[]{
                ...
                /*5*/"所在单位|300", /*"现任职务|160",*/ "所在单位及职务|300", "行政级别|100", "职务属性|100",
                /*9*/"是否正职|120",  "是否班子负责人|120", "性别|50", "民族|100", "籍贯|100",
                /*14*/"出生地|100", "身份证号|150", "出生时间|100", "年龄|50", "政治面貌|150",
                /*19*/"党派加入时间|120", "参加工作时间|120", "到校日期|100", "最高学历|120", "最高学位|120",
                /*24*/"毕业时间|100", "学习方式|120", "毕业学校|200", "学校类型|100", "所学专业|200",
                /*29*/"全日制教育学历|150", "全日制教育毕业院校系及专业|400", "在职教育学历|150", "在职教育毕业院系及专业|400", "最高毕业院校及专业|400",
