...
public class UnitTransferService extends BaseMapper {
    ...
    public int insertSelective(UnitTransfer record){
        ...
        record.setSortOrder(getNextSortOrder("unit_transfer", null));
    ...
    public void changeOrder(int id, int addNum) {
        ...
        if(overEntities.size()>0) {
            ...
            if (addNum > 0)
                commonMapper.downOrder("unit_transfer", null, baseSortOrder, targetEntity.getSortOrder());
            else
                commonMapper.upOrder("unit_transfer", null, baseSortOrder, targetEntity.getSortOrder());
