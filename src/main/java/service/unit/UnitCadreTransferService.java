...
public class UnitCadreTransferService extends BaseMapper {
    ...
    public void changeOrder(int id, int addNum) {
        ...
        if(overEntities.size()>0) {
            ...
            if (addNum > 0)
                commonMapper.downOrder("unit_cadre_transfer",null, baseSortOrder, targetEntity.getSortOrder());
            else
                commonMapper.upOrder("unit_cadre_transfer",null, baseSortOrder, targetEntity.getSortOrder());
