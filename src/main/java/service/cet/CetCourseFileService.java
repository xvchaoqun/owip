...
public class CetCourseFileService extends BaseMapper {
    ...
    public void changeOrder(int id, int addNum) {
        ...
        if(overEntities.size()>0) {
            ...
            if (addNum*orderBy > 0)
                commonMapper.downOrder("cet_course_file", "course_id="+ entity.getCourseId(), baseSortOrder, targetEntity.getSortOrder());
            else
                commonMapper.upOrder("cet_course_file", "course_id="+ entity.getCourseId(), baseSortOrder, targetEntity.getSortOrder());
