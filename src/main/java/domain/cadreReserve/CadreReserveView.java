...
public class CadreReserveView implements Serializable {
    ...
    public Date getReservePostTime() {
        return reservePostTime;
    }

    public void setReservePostTime(Date reservePostTime) {
        this.reservePostTime = reservePostTime;
    }
