...
public class PmdBranchView implements Serializable {
    ...
    public PmdReportBean getR(){
        ...
        return iPmdMapper.getBranchPmdReportBean(monthId, partyId, branchId);
    }
    ...
    public boolean getCanReport() {
        ...
        PmdBranchService pmdBranchService = CmTag.getBean(PmdBranchService.class);
        return pmdBranchService.canReport(monthId, partyId, branchId);
    }
