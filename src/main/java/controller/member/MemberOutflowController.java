...
public class MemberOutflowController extends MemberBaseController {
    ...
    public String memberOutflow_view(int userId, ModelMap modelMap) {
        ...
        return "member/memberOutflow/memberOutflow_view";
    }
    ...
    public String memberOutflow(@RequestParam(defaultValue = "1")byte cls,Integer userId,
        ...
        return "member/memberOutflow/memberOutflow_page";
    }
    @RequiresPermissions("memberOutflow:list")
    ...
    public void memberOutflow_data(@RequestParam(defaultValue = "1")byte cls, HttpServletResponse response,
        ...
        int count = (int) memberOutflowViewMapper.countByExample(example);
    ...
    public String memberOutflow_au(Integer id, ModelMap modelMap) {
        ...
        return "member/memberOutflow/memberOutflow_au";
    }
   ...
   /* @RequiresPermissions("memberOutflow:del")
    ...
    public void memberOutflow_export(MemberOutflowViewExample example, HttpServletResponse response) {
        ...
        String[] titles = {"学工号|100","姓名|100","所在党组织|300|left","所在党支部|300|left","原职业|150|left","外出流向|150|left",
