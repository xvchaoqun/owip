...
@Controller
@RequestMapping("/user")
public class UserMemberInflowController extends MemberBaseController {
    ...
    public String memberInflow_base(@CurrentUser SysUserView loginUser, ModelMap modelMap) {
        ...
        return "member/user/memberInflow/memberInflow_base";
    }
    ...
    public String memberInflowOut(@CurrentUser SysUserView loginUser, ModelMap modelMap) {
        ...
        if(memberInflow.getOutStatus()==null ||
            ...
            return "member/user/memberInflow/memberInflowOut_au";

        return "member/user/memberInflow/memberInflowOut";
    }
