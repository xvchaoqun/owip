...
@Controller
@RequestMapping("/dp")
public class DpMemberBaseInfoController extends MemberBaseController {

    private Logger logger = LoggerFactory.getLogger(getClass());
    @Autowired
    private AvatarService avatarService;

    @RequiresPermissions("dpMemberBaseInfo:edit")
    @RequestMapping("/dpMemberBaseInfo_au")
    public String dpMemberBaseInfo_au(int userId, ModelMap modelMap) {
        ...
        if (sysUser.isCasUser()) {
            ...
            return "dp/dpUserInfo/baseInfo_au";
            ...
            return "dp/dpUserInfo/teacherInfo_au";
        } else {
            ...
            return "dp/dpUserInfo/studentInfo_au";
        }
