...
public class StatOwController extends BaseController {
    ...
    public String stat_ow_sum(@RequestParam(required = false, defaultValue = "0") int export,
        ...
        //师生党员总数
        modelMap.put("totalCount", statMemberMapper.getMemberCount(null, null, null, null, null, null));
        //教工党员总数
        modelMap.put("teacherCount", statMemberMapper.getMemberCount(teacherTypes, null, null, null, null, null));
        //正高级
        modelMap.put("chiefCount", statMemberMapper.getMemberCount(teacherTypes, "正高", branchIdList, null, null, null));
        //副高级
        modelMap.put("deputyCount", statMemberMapper.getMemberCount(teacherTypes, "副高", branchIdList, null, null, null));
        //中级及以下
        modelMap.put("middleCount", statMemberMapper.getMemberCount(teacherTypes, null, branchIdList, "正高", "副高", null));
        //离退休教工党员总数
        modelMap.put("retireTeacherCount", statMemberMapper.getMemberCount(Arrays.asList(SystemConstants.USER_TYPE_RETIRE), null, null, null, null, null));
        //本科生党员
        int bksStuCount = statMemberMapper.getMemberCount(Arrays.asList(SystemConstants.USER_TYPE_BKS), null, null, null, null, null);
        modelMap.put("bksStuCount", bksStuCount);
        //硕士生党员
        int ssStuCount = statMemberMapper.getMemberCount(Arrays.asList(SystemConstants.USER_TYPE_SS), null, null, null, null, null);
        modelMap.put("ssStuCount", ssStuCount);
        //博士生党员
        int bsStuCount = statMemberMapper.getMemberCount(Arrays.asList(SystemConstants.USER_TYPE_BS), null, null, null, null, null);
