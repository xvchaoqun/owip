...
/**
 * Created by fafa on 2016/9/10.
 */
@Controller
@RequestMapping("/ke")
public class KeController extends BaseController {

    @RequestMapping("/upload_json")
    public void upload_json(HttpServletRequest request, HttpServletResponse response,
                            @RequestParam(value = "imgFile") MultipartFile[] files, PrintWriter out) throws FileUploadException {
        ...
        for (MultipartFile file : files) {
            ...
            try {
                FileUtils.saveFile(file, uploadedFile);
            } catch (Exception e) {
    ...
    public void file_manager_json(HttpServletRequest request, HttpServletResponse response, PrintWriter out) {
