...
/*	public final static Map<String, String> HTML_FRAGMENT_MAP = new LinkedHashMap<>();
    ...
    static {
        SCHEDULER_JOB_MAP.put(SCHEDULER_JOB_TOBEEXECUTED, "正在执行");
    ...
    static {
        ...
        USER_TYPE_MAP.put(USER_TYPE_RETIRE, "离退休");
        USER_TYPE_MAP.put(USER_TYPE_BKS, "本科生");
        USER_TYPE_MAP.put(USER_TYPE_SS, "硕士生");
        USER_TYPE_MAP.put(USER_TYPE_BS, "博士生");
    }
