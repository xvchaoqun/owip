...
public class AbroadConstants {
    ...
    static {
        ABROAD_APPLICAT_CADRE_STATUS_SET.add(SystemConstants.CADRE_STATUS_MIDDLE);
        ABROAD_APPLICAT_CADRE_STATUS_SET.add(SystemConstants.CADRE_STATUS_LEADER);
        ABROAD_APPLICAT_CADRE_STATUS_SET.add(SystemConstants.CADRE_STATUS_LEADER_LEAVE);
    }
}
