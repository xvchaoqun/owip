...
public class OwConstants {
    ...
    static {
        ...
        OW_ENTER_APPLY_STATUS_MAP.put(OW_ENTER_APPLY_STATUS_ADMIN_ABORT, "退回");
    ...
    static {
        ...
        OW_APPLY_APPROVAL_LOG_TYPE_MAP.put(OW_APPLY_APPROVAL_LOG_TYPE_USER_REG, "账号注册");
