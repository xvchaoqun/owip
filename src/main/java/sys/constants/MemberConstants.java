...
public class MemberConstants {
    ...
    static {
        ...
        MEMBER_QUIT_STATUS_MAP.put(MEMBER_QUIT_STATUS_PARTY_VERIFY, "二级党委审核通过");
    ...
    static {
        ...
        MEMBER_OUT_STATUS_MAP.put(MEMBER_OUT_STATUS_PARTY_VERIFY, "二级党委审核通过");
    ...
    static {
        ...
        MEMBER_IN_STATUS_MAP.put(MEMBER_IN_STATUS_PARTY_VERIFY, "二级党委审核通过");
    ...
    static {
        ...
        MEMBER_TRANSFER_STATUS_MAP.put(MEMBER_TRANSFER_STATUS_FROM_VERIFY, "转出党委审核通过");
        MEMBER_TRANSFER_STATUS_MAP.put(MEMBER_TRANSFER_STATUS_TO_VERIFY, "审核通过");
    }
    ...
    static {
        ...
        MEMBER_INFLOW_STATUS_MAP.put(MEMBER_INFLOW_STATUS_PARTY_VERIFY, "审核通过");
    }
    ...
    static {
        ...
        MEMBER_INFLOW_OUT_STATUS_MAP.put(MEMBER_INFLOW_OUT_STATUS_PARTY_VERIFY, "审核通过");
    }
    ...
    static {
        ...
        MEMBER_OUTFLOW_STATUS_MAP.put(MEMBER_OUTFLOW_STATUS_PARTY_VERIFY, "审核通过");
    }
    ...
    static {
        ...
        MEMBER_STAY_STATUS_MAP.put(MEMBER_STAY_STATUS_PARTY_VERIFY, "二级党委审核通过");
    ...
    static {
        ...
        MEMBER_CERTIFY_STATUS_MAP.put(MEMBER_CERTIFY_STATUS_PARTY_VERIFY, "二级党委审核通过");
