...
public class ModifyConstants {
    ...
    public final static byte MODIFY_TABLE_APPLY_MODULE_CADRE_FAMILY = 17;
    public final static byte MODIFY_TABLE_APPLY_MODULE_CADRE_FAMILYABROAD = 18;
    ...
    static {
        ...
        MODIFY_TABLE_APPLY_MODULE_MAP.put(MODIFY_TABLE_APPLY_MODULE_CADRE_FAMILY, "家庭成员信息");
        MODIFY_TABLE_APPLY_MODULE_MAP.put(MODIFY_TABLE_APPLY_MODULE_CADRE_FAMILYABROAD, "家庭成员移居国（境）外的情况");
