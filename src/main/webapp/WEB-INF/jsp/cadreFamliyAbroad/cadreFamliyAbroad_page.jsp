...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="myTableDiv"
             data-url-au="${ctx}/cadreFamliyAbroad_au"
             data-url-page="${ctx}/cadreFamliyAbroad_page"
             data-url-del="${ctx}/cadreFamliyAbroad_del"
             data-url-bd="${ctx}/cadreFamliyAbroad_batchDel"
             data-url-co="${ctx}/cadreFamliyAbroad_changeOrder"
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <c:forEach items="${cadreFamliyAbroads}" var="cadreFamliyAbroad" varStatus="st">
                        <tr>
                            <td class="center">
                                <label class="pos-rel">
                                    <input type="checkbox" value="${cadreFamliyAbroad.id}" class="ace">
                                    <span class="lbl"></span>
                                </label>
                            </td>
								<td>${cadreFamliyAbroad.famliyId}</td>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <shiro:hasPermission name="cadreFamliyAbroad:edit">
                                    <button data-id="${cadreFamliyAbroad.id}" class="editBtn btn btn-mini">
                                        <i class="fa fa-edit"></i> 编辑
                                    </button>
                                     </shiro:hasPermission>
                                     <shiro:hasPermission name="cadreFamliyAbroad:del">
                                    <button class="delBtn btn btn-danger btn-mini" data-id="${cadreFamliyAbroad.id}">
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            ...
                                            <shiro:hasPermission name="cadreFamliyAbroad:edit">
                                            <li>
                                                <a href="#" data-id="${cadreFamliyAbroad.id}" class="editBtn tooltip-success" data-rel="tooltip" title="编辑">
                                                    <span class="green">
                                            ...
                                            <shiro:hasPermission name="cadreFamliyAbroad:del">
                                            <li>
                                                <a href="#" data-id="${cadreFamliyAbroad.id}" class="delBtn tooltip-error" data-rel="tooltip" title="删除">
                                                    <span class="red">
                    ...
                    <div class="row my_paginate_row">
                        ...
                        <div class="col-xs-6">
                            <div class="my_paginate">
                                <ul class="pagination">
                                    <wo:page commonList="${commonList}" uri="${ctx}/cadreFamliyAbroad_page" target="#page-content" pageNum="5"
                                             model="3"/>
                                </ul>
                            </div>
                        </div>
