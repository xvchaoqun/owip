...
<body class="login_body">
    ...
    <table class="dr_login_bg" border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        <tbody>
            ...
            <tr>
                <td>
                    <table class="login_bg_mid" style="background:url(/img/dr_login_bg.png?_=${cm:lastModified(cm:getAbsolutePath('/img/dr_login_bg.png'))})" border="0" cellspacing="0" cellpadding="0" width="820"
