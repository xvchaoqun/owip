            ...
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="drVoterTypeTpl:edit">
                    <button class="popupBtn btn btn-success btn-sm"
                            data-url="${ctx}/drVoterTypeTpl_au">
                    ...
                    <button class="jqOpenViewBtn btn btn-warning btn-sm"
                            data-url="${ctx}/drVoterTypeTpl_type">
                        <i class="fa fa-bars"></i> 编辑类型
                    </button>
                </shiro:hasPermission>
                <shiro:hasPermission name="drVoterTypeTpl:del">
                    <button data-url="${ctx}/drVoterTypeTpl_batchDel"
                            data-title="删除"
...
<script>
    function openView(tplId, pageNo){
        pageNo = pageNo||1;
        $.loadModal( "${ctx}/drVoterTypeTpl_type?id="+tplId + "&pageNo="+pageNo);
    }

    $("#jqGrid").jqGrid({
        rownumbers:true,
        url: '${ctx}/drVoterTypeTpl_data?callback=?&${cm:encodeQueryString(pageContext.request.queryString)}',
        colModel: [
