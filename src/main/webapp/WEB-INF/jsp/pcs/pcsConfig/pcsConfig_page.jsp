...
<script>
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '提交提案时间', name: 'proposalSubmitTime', width: 130, formatter: 'date', formatoptions: {srcformat:'Y-m-d H:i',newformat:'Y-m-d H:i'}},
            {label: '征集附议人时间', name: 'proposalSupportTime', width: 130, formatter: 'date', formatoptions: {srcformat:'Y-m-d H:i',newformat:'Y-m-d H:i'}},
