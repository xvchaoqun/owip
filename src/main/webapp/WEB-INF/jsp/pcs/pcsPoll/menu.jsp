...
<ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
    <li class="<c:if test="${cls==1&&param.isDeleted==0}">active</c:if>">
        <a href="javascript:;" class="loadPage" data-url="${ctx}/pcs/pcsPoll?cls=1&isDeleted=0"><i class="fa fa-list"></i> 党代会投票</a>
    </li>
    <li class="<c:if test="${cls==1&&param.isDeleted==1}">active</c:if>">
        <a href="javascript:;" class="loadPage" data-url="${ctx}/pcs/pcsPoll?cls=1&isDeleted=1"><i class="fa fa-trash-o"></i> 已作废（${cancelCount}）</a>
    </li>
