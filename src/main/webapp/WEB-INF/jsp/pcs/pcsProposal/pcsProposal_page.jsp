...
<div class="row">
    <div class="col-xs-12">
        ...
        <div id="body-content" class="myTableDiv"
                 data-url-page="${ctx}/pcsProposal_page"
                 data-url-export="${ctx}/pcsProposal_data"
                 data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            <c:set var="_query" value="${not empty param.configId || not empty param.code || not empty param.sort}"/>
                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        ...
                        <div class="form-group">
                            <label>所属党代会</label>
                            <input class="form-control search-query" name="configId" type="text" value="${param.configId}"
                                   placeholder="请输入所属党代会">
                        </div>
...
<script>
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            { label: '类型 1 党委委员 2 纪委委员',name: 'type'},
            { label: '所属党代会',name: 'configId'},
