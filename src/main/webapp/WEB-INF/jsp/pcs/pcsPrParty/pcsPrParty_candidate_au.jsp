                                        ...
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><span class="title">
                                                ...
                                                <select id="select${_type.key}" data-rel="select2-ajax"
                                                        data-ajax-url="${ctx}/member_selects?noAuth=1&type=${_memberType}&isRetire=${_isRetire}&politicalStatus=<%=MemberConstants.MEMBER_POLITICAL_STATUS_POSITIVE%>&status=${_status}"
