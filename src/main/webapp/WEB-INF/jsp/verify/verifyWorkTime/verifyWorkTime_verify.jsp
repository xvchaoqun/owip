...
<div class="row" style="width: 700px">
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title"><i class="fa fa-check blue"></i> 参加工作时间认定（${verifyWorkTime.cadre.realname} - ${verifyWorkTime.cadre.title}）</h4>
        </div>
        <div class="widget-body">
            <div class="widget-main">
                <form class="form-horizontal" action="${ctx}/verifyWorkTime_verify" autocomplete="off" disableautocomplete id="modalForm" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            ...
                            <script>
                                $("#modalForm select[name=type]").val('${verifyWorkTime.type}');
                            </script>
                        </div>
                    </div>
                        <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <textarea class="form-control limited" type="text"
                                      name="remark" rows="5">${verifyWorkTime.remark}</textarea>
                        </div>
                    </div>
                </form>
