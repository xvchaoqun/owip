...
<div class="modal-body">
  <form class="form-horizontal"  action="${ctx}/cet/cetTrainCourse_selectObjs" id="modalForm" method="post">
...
<script>
  ...
  $(function(){
    $.getJSON("${ctx}/cet/cetTrainCourse_selectObjs_tree",{trainCourseId:"${param.trainCourseId}"},function(data){
    ...
    $("#modal form").validate({
      ...
      submitHandler: function (form) {
        ...
        $(form).ajaxSubmit({
          data:{userIds:userIds, trainCourseId:"${param.trainCourseId}"},
