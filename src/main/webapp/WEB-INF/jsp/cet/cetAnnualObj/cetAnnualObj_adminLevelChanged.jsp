...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cet/cetAnnualObj_singleRequire" autocomplete="off" disableautocomplete id="modalForm" method="post">
			...
			<label class="col-xs-5 control-label">行政级别</label>
				<div class="col-xs-6 label-text">
                    ${cm:getMetaType(latestAdminLevel).name} （变更前：${cm:getMetaType(cetAnnualObj.adminLevel).name}）
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-5 control-label"><span class="star">*</span>年度学习任务</label>
				<div class="col-xs-3">
                        <input required class="form-control period" type="text" name="period" data-rule-min="0.5">
				</div>
				（变更前：${cm:trimToZero(cetAnnualObj.period)}）
			</div>
			...
			<div class="form-group">
				...
				（变更前：${cm:trimToZero(cetAnnualObj.maxSpecialPeriod)}）
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				（变更前：${cm:trimToZero(cetAnnualObj.maxPartyPeriod)}）
			</div>
			<div class="form-group">
				...
				（变更前：${cm:trimToZero(cetAnnualObj.maxUnitPeriod)}）
			</div>
			<div class="form-group">
				...
				（变更前：${cm:trimToZero(cetAnnualObj.maxUpperPeriod)}）
			</div>
			<div class="form-group">
