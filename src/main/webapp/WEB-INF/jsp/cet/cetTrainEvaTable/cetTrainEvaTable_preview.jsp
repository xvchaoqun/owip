...
<c:set var="normNum" value="${cetTrainEvaTable.normNum}"></c:set>
<c:set var="rankNum" value="${cetTrainEvaTable.rankNum}"></c:set>
<table class="t1">
    <tbody>
    <tr>
        <td colspan="${2+rankNum}">
            <p class="p1">
                <span class="s1">${cetTrainEvaTable.name}</span>
            </p>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <c:forEach items="${cetTrainEvaTable.ranks}" var="rank">
        <td class="td4">
            <p class="p4">
                <span>${rank.name}</span>
            </p>
    ...
    <c:forEach items="${cetTrainEvaTable.norms}" var="norm">
