    ...
    $("#jqGrid_popup").jqGrid({
        ...
        colModel:[
            ...
            { label: '选课方式',name: '_status', width: 80, formatter: function (cellvalue, options, rowObject) {
                if(rowObject.objCourseView==undefined) return '-'
