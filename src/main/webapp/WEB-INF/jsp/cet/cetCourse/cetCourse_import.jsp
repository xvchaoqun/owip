...
<div class="modal-body">
    <form class="form-horizontal" id="modalForm" enctype="multipart/form-data"
          action="${ctx}/cet/cetCourse_import" method="post">
    ...
    <div class="well">
        <span class="help-inline">导入的文件请严格按照<a
                href="${ctx}/attach?code=sample_cetCourse">线下课程录入样表.xlsx</a>（点击下载）的数据格式</span>
        <div class="text text-danger bolder" style="margin-top: 15px;">
            注：同一年份的课程，如果编号相同，将进行覆盖更新操作，且不可还原</div>
    </div>
</div>
