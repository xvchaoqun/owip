...
<!-- PAGE CONTENT BEGINS -->
<div id="body-content3" class="myTableDiv"
            ...
            <div id="home4" class="tab-pane in active">
                <div class="jqgrid-vertical-offset buttons">
                    ...
                    <shiro:hasPermission name="cetTrain:edit">
                        <button class="popupBtn btn btn-info btn-sm" data-url="${ctx}/cet/cetTrain_au?planId=${param.planId}"><i
    ...
    $("#jqGrid3").jqGrid({
        ...
        colModel: [
            {label: '详情', name: '_detail', width:'80', formatter: function (cellvalue, options, rowObject) {
                return ('<button class="openView3 btn btn-success btn-xs" ' +
