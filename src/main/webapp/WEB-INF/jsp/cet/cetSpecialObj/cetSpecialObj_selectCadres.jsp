...
<%@ include file="/WEB-INF/jsp/common/taglibs.jsp"%>         
  <div class="modal-header">
    ...
    <h4>选择培训对象（${CET_SPECIAL_OBJ_TYPE_MAP.get(cm:toByte(param.type))}）</h4>
  </div>
  <div class="modal-body">
  <form class="form-horizontal"  action="${ctx}/cet/cetSpecialObj_add" id="modalForm" method="post">
  ...
  <script>
	...
	$(function(){
		$.getJSON("${ctx}/cet/cetSpecialObj_selectCadres_tree",{specialId:"${param.specialId}"},function(data){
		...
		$("#modal form").validate({
				...
				submitHandler: function (form) {
					...
					$(form).ajaxSubmit({
						data:{userIds:userIds, specialId:"${param.specialId}", type: "${param.type}"},
