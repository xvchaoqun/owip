...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cet/cetProjectObj_au" autocomplete="off" disableautocomplete
        ...
        <div class="form-group">
            ...
            <div class="col-xs-7">
                ...
                <script>
                    $("#modalForm select[name=traineeTypeId]").val('${traineeTypeId}')
                </script>
            </div>
        </div>
        <div class="form-group">
			<label class="col-xs-3 control-label"><span class="star">*</span>参训人员</label>
                ...
                <c:if test="${not empty cetProjectObj}">
                    ...
                    ${cetProjectObj.user.realname}
                        <input type="hidden" name="userId" value="${cetProjectObj.userId}"/>
                        </div>
                </c:if>
                <c:if test="${empty cetProjectObj}">
                    <div class="col-xs-7">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <textarea class="form-control noEnter" rows="3" name="title">${cetProjectObj.title}</textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-7">
                ...
                <script type="text/javascript">
                    $("#modalForm select[name=postType]").val(${cetProjectObj.postType});
                </script>
            </div>
        </div>
