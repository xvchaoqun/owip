            ...
            <form class="form-inline search-form" id="searchForm2">
                ...
                <div class="clearfix form-actions center">
                    <a class="jqSearchBtn btn btn-default btn-sm"
                       ...
                       data-url="${ctx}/cet/cetProjectObj?projectId=${cetProject.id}&planId=${cetProjectPlan.id}&trainCourseId=${param.trainCourseId}&planCourseId=${param.planCourseId}"><i class="fa fa-search"></i> 查找</a>
                    <c:if test="${_query}">&nbsp;
                        <button type="button" class="resetBtn btn btn-warning btn-sm"
                                data-target="#detail-content-view"
                                data-url="${ctx}/cet/cetProjectObj?projectId=${cetProject.id}&planId=${cetProjectPlan.id}&traineeTypeId=${traineeTypeId}&cls=${cls}&isQuit=${isQuit}&trainCourseId=${param.trainCourseId}&planCourseId=${param.planCourseId}">
