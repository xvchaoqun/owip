        ...
        colModel: [
                ...
                }},
            {
                ...
                if ($.trim(pdfFilePath) != '') {
                    ...
                    ret = '<button data-width="900" data-url="${ctx}/pdf_preview?path={0}&filename={1}"  title="PDF文件预览" class="popupBtn btn btn-xs btn-primary"><i class="fa fa-search"></i> 预览</button>'
