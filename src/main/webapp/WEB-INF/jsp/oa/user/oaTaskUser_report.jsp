                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <c:forEach var="file" items="${oaTaskFiles}">
                                <div>
                                    <a href="${ctx}/attach_download?path=${cm:sign(file.filePath)}&filename=${cm:encodeURI(file.fileName)}">${file.fileName}</a>
                                </div>
                            </c:forEach>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <c:forEach var="file" items="${oaTaskUserFiles}">
                                <div class="file">
                                    <a href="${ctx}/attach_download?path=${cm:sign(file.filePath)}&filename=${cm:encodeURI(file.fileName)}"
