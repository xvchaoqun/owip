...
<div class="modal-body">
    <shiro:hasPermission name="oaTask:edit">
        <form class="form-horizontal" action="${ctx}/oa/oaTaskFile_au" autocomplete="off" disableautocomplete id="modalForm" method="post">
    ...
    <div class="popTableDiv"
        ...
        <table class="table table-actived table-striped table-bordered table-hover">
            ...
            <c:forEach items="${oaTaskFiles}" var="oaTaskFile" varStatus="st">
                <tr>
                    <td nowrap title="${oaTaskFile.fileName}">${cm:substr(oaTaskFile.fileName, 0, 40, '...')}</td>
                    <td nowrap>
                        <div class="hidden-sm hidden-xs action-buttons">
                            ...
                            <button class="downloadBtn btn btn-xs btn-info" data-type="download"
                               data-url="${ctx}/attach_download?path=${cm:sign(oaTaskFile.filePath)}&filename=${oaTaskFile.fileName}">
