...
<%@ include file="/WEB-INF/jsp/common/taglibs.jsp"%>         
  <div class="modal-header">
    ...
    <h4>"${oaTask.name}"所包含的任务对象
    </h4>
  </div>
  <div class="modal-body">
  <form class="form-horizontal"  action="${ctx}/oa/oaTask/selectUsers" autocomplete="off" disableautocomplete id="modalForm" method="post">
  ...
  <script>
	...
	$(function(){
		$.getJSON("${ctx}/oa/oaTask/selectUsers_tree",{id:"${param.id}"},function(data){
