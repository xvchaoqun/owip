...
<div class="modal-header">
    ...
    <h3><c:if test="${oaTaskRemind!=null}">编辑</c:if><c:if test="${oaTaskRemind==null}">添加</c:if>任务对象本人设置的通知提醒</h3>
</div>
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/oa/oaTaskRemind_au" autocomplete="off" disableautocomplete id="modalForm" method="post">
