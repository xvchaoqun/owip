            ...
            <div class="tab-content" style="padding: 0px;">
                <div class="tab-pane in active">
                        ...
                        <div class="message-list">
                            ...
                            <c:forEach items="${parttimeApplys}" var="parttimeApply">
                                ...
                                <div class="openView message-item" data-open-by="page"
                                     data-url="${ctx}/m/parttime/parttimeApply_view?id=${parttimeApply.id}&status=${status}&type=admin">
                                ...
                                <span class="summary">
                                    ...
                                    <c:if test="${status==0}">
                                        <c:if test="${parttimeApply.flowNode<=0}">
                    ...
                    <div class="message-footer clearfix">
                        <wo:page commonList="${commonList}" uri="${ctx}/m/parttime/parttimeApply_page" target="#page-content" model="4"/>
                    </div>
                </div>
            </div>
        </div>
...
<!-- PAGE CONTENT ENDS -->
<script>
    $("#myTab4 .parttimeApplyLi").click(function () {

        $("#page-content").load("${ctx}/m/parttime/parttimeApply_page?status="+$(this).data("status"));
    });
</script>