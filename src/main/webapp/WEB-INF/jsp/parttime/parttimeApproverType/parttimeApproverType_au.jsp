...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/parttimeApproverType_au" autocomplete="off" disableautocomplete id="modalForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
                    <select required name="type" data-rel="select2" data-placeholder="请选择"> 
                        <option></option>
                          <c:forEach items="${PARTTIME_APPROVER_TYPE_MAP}" var="type"> 
