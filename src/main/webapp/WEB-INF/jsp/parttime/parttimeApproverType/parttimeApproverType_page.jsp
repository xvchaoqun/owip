...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="myTableDiv"
             data-url-au="${ctx}/parttimeApproverType_au"
             data-url-page="${ctx}/parttimeApproverType"
             data-url-del="${ctx}/parttimeApproverType_del"
             data-url-bd="${ctx}/parttimeApproverType_batchDel"
             data-url-co="${ctx}/parttime/parttimeApproverType_changeOrder"
            ...
            <c:if test="${commonList.recNum>0}">
                    ...
                    <c:forEach items="${approverTypes}" var="approverType" varStatus="st">
                        <tr>
								...
								<td>
                                    ...
                                    <c:if test="${approverType.type!=CADRE_APPROVER_TYPE_UNIT && approverType.type!=CADRE_APPROVER_TYPE_LEADER}">
                                    <button data-url="${ctx}/parttimeApproverType/selectCadres?type=${approverType.type}&id=${approverType.id}"
                ...
                <wo:page commonList="${commonList}" uri="${ctx}/parttimeApproverType" target="#page-content" pageNum="5"
                         model="3"/>
            </c:if>
            <c:if test="${commonList.recNum==0}">
