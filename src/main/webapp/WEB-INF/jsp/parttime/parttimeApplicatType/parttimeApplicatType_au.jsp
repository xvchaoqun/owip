...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/parttimeApplicatType_au" autocomplete="off" disableautocomplete id="modalForm" method="post">
...
<div class="modal-footer">
    ...
    <input type="submit" class="btn btn-primary" value="<c:if test="${applicatType!=null}">确定</c:if><c:if test="${applicatType==null}">添加</c:if>"/>
</div>
