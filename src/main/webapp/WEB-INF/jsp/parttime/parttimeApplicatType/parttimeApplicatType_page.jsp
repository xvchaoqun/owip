...
<div class="row">
    <div class="col-xs-12">
        ...
        <div id="body-content">
        <div class="tabbable">
            <jsp:include page="/WEB-INF/jsp/parttime/parttimeApprovalAuth/parttimeApprovalAuth_menu.jsp"/>

            <div class="tab-content">
                <div class="tab-pane in active">

        <div class="myTableDiv"
             data-url-au="${ctx}/parttimeApplicatType_au"
             data-url-page="${ctx}/parttimeApplicatType"
             data-url-del="${ctx}/parttimeApplicatType_del"
             data-url-bd="${ctx}/parttimeApplicatType_batchDel"
             data-url-co="${ctx}/parttimeApplicatType_changeOrder"
             data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            <div class="buttons">
                <a class="editBtn btn btn-info btn-sm"><i class="fa fa-plus"></i> 添加</a>
                <a class="popupBtn btn btn-danger btn-sm"
                   data-url="${ctx}/parttimeApplicatType/selectCadresEscape"><i class="fa fa-search"></i> 未分配申请人身份的干部（${escapeCount}）</a>
            </div>
            ...
            <c:if test="${commonList.recNum>0}">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach items="${applicatTypes}" var="applicatType" varStatus="st">
                        <tr>
                            ...
                            <td>
                                <button data-url="${ctx}/parttimeApplicatType/selectCadres?id=${applicatType.id}" class="popupBtn btn btn-success btn-xs">
                                    <i class="fa fa-th-list"></i>  包含干部
                                </button>
                            </td>
                            <td>
                                <button data-url="${ctx}/parttime/parttimeApprovalOrder?id=${applicatType.id}" class="popupBtn btn btn-warning btn-xs">
                ...
                <wo:page commonList="${commonList}" uri="${ctx}/parttimeApplicatType" target="#page-content" pageNum="5"
                         model="3"/>
            </c:if>
            <c:if test="${commonList.recNum==0}">
