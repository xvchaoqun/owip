...
<%@ include file="/WEB-INF/jsp/common/taglibs.jsp"%>         
  ...
  <form class="form-horizontal"  action="${ctx}/parttimeApplicatType/selectCadres" autocomplete="off" disableautocomplete id="modalForm" method="post">
  ...
  <script>
	...
	$(function(){
		$.getJSON("${ctx}/parttimeApplicatType/selectCadres_tree",{id:"${param.id}"},function(data){
