...
<div class="modal-body">
        <div class="widget-box">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal no-footer" action="${ctx}/parttime/parttimeApprovalOrder" autocomplete="off" disableautocomplete id="modalForm" method="post">
    ...
    <div class="popTableDiv"
         data-url-page="${ctx}/parttime/parttimeApprovalOrder?id=${applicatType.id}"
         data-url-del="${ctx}/parttimeApplicatType/parttimeApprovalOrder_del"
         data-url-co="${ctx}/parttimeApplicatType/parttimeApprovalOrder_changeOrder?applicatTypeId=${applicatType.id}">
            ...
            <table class="table table-actived table-striped table-bordered table-hover">
                ...
                <c:forEach items="${approvalOrders}" var="approvalOrder" varStatus="st">
                    ...
                    <c:if test="${!empty commonList && commonList.pageNum>1 }">
                        <wo:page commonList="${commonList}" uri="${ctx}/parttime/parttimeApprovalOrder" target="#modal .modal-content"
                                 pageNum="5"
                                 model="3"/>
                    </c:if>
        </c:if>
