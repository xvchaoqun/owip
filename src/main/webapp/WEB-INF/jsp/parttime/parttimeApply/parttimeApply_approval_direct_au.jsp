...
<div class="modal-body">
  <form autocomplete="off" disableautocomplete id="modalForm" class="form-horizontal" method="post" action="${ctx}/parttime/parttimeApply_approval_direct_au">
        ...
        success: function (ret) {
          if (ret.success) {
            ...
            SysMsg.success("修改成功。", function(){
              $.openView("${ctx}/parttime/parttimeApply_view?id=${param.applyId}&type=${param.type}&approvalTypeId=${param.approvalTypeId}")
            })
          }
        }
      });
