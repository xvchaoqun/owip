    ...
    <div class="form-group">
        ...
        <div class="col-xs-6">
            <select data-rel="select2-ajax"
                    data-ajax-url="${ctx}/cadre_selects?status=${CADRE_STATUS_CJ},${CADRE_STATUS_KJ}" data-width="350"
...
<script>
    ...
    $("#modal #submitBtn").click(function(){
        ...
        if(cadreId=="") return;
        $("#modal").modal('hide');
        // cadreCompanyDeclare_au_form
        $.openView("${ctx}/parttimeApply_au_page?cadreId=" + cadreId);
    })
</script>