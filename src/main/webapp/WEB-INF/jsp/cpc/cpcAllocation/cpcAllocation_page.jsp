        ...
        <div id="body-content" class="myTableDiv"
            ...
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="cpcAllocation:edit">
                    <a class="popupBtn btn btn-info btn-sm"  data-url="${ctx}/cpcAllocation_au"><i class="fa fa-plus"></i> 添加</a>
                    <a class="jqOpenViewBtn btn btn-primary btn-sm"
                       data-url="${ctx}/cpcAllocation_au"
                       data-grid-id="#jqGrid"
                       data-querystr="&"><i class="fa fa-edit"></i>
                        修改</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="cpcAllocation:del">
                    <button data-url="${ctx}/cpcAllocation_batchDel"
                            data-title="删除"
...
<script>
    $("#jqGrid").jqGrid({
        url: '${ctx}/cpcAllocation_data?callback=?&${cm:encodeQueryString(pageContext.request.queryString)}',
        colModel: [
            { label: '单位',name: 'unitId'},
            { label: '行政级别',name: 'postId'},
            { label: '数量',name: 'num'}
        ]
