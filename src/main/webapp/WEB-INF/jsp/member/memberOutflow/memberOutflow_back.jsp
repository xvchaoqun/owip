...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/memberOutflow_back" autocomplete="off" disableautocomplete id="modalForm" method="post">
				...
				<div class="col-xs-6">
                    <div class="input-group">
                        <select name="status" data-rel="select2">
                            <c:forEach var="_status" items="${cm:inverseMap(MEMBER_OUTFLOW_STATUS_MAP)}">
                                <c:if test="${_status.key>=MEMBER_OUTFLOW_STATUS_BACK && _status.key<=param.status}">
