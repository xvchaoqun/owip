                ...
                <div class="tabbable">
                    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
                        <li class="${cls==1?'active':''}">
                            <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=1"}><i class="fa fa-circle-o"></i> 支部待审核</a>
                        </li>
                        <li class="${cls==5?'active':''}">
                            <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=5"}><i class="fa fa-check-circle-o"></i> 支部已审核</a>
                        </li>

                        <li class="${cls==6?'active':''}">
                            <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=6"}><i class="fa fa-stop-circle-o"></i> ${_p_partyName}待审核</a>
                        </li>
