                    ...
                    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
                        <li class="dropdown <c:if test="${cls==1||cls==4||cls==5}">active</c:if>" >
                            ...
                            <ul class="dropdown-menu dropdown-info" style="min-width: 100px">
                                <li>
                                    <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=1"><i class="fa fa-hand-o-right"></i> 新申请</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=4"><i class="fa fa-hand-o-right"></i> 返回修改</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=5"><i class="fa fa-hand-o-right"></i> 已审核</a>
                                </li>
                            </ul>
                        </li>
                        <li class="${cls==6?'active':''}">
                            <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=6"}><i class="fa fa-circle-o"></i> ${_p_partyName}审核</a>
                        </li>
                        <li class="${cls==2?'active':''}">
                            <a href="javascript:;" class="loadPage" data-url="${ctx}/memberInflowOut?cls=2"}><i class="fa fa-times"></i> 未通过/已撤销</a>
                        </li>
                        ...
                        <div class="tab-pane in active">
                            <div class="jqgrid-vertical-offset buttons">
                                ...
                                <button class="jqOpenViewBtn btn btn-info btn-sm"
                                        ...
                                        data-querystr="&type=<%=OwConstants.OW_APPLY_APPROVAL_LOG_TYPE_MEMBER_INFLOW_OUT%>"
                                        data-open-by="page">
                                                        ...
                                                        <label>用户</label>
                                                            <div class="input-group">
                                                                ...
                                                                <select data-rel="select2-ajax"
                                                                        data-ajax-url="${ctx}/memberInflow_selects?status=<%=MemberConstants.MEMBER_INFLOW_STATUS_PARTY_VERIFY%>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select name="status" data-rel="select2" data-placeholder="请选择">
                                                        <option></option>
                                                        <c:forEach var="_status" items="<%=MemberConstants.MEMBER_INFLOW_OUT_STATUS_MAP%>">
...
<script>
    ...
    $("#jqGrid").jqGrid({
        ...
        onSelectRow: function(id,status){
            ...
            if(ids.length>1){
                ...
                $("#branchApprovalBtn").prop("disabled",rowData.outStatus!="<%=MemberConstants.MEMBER_INFLOW_OUT_STATUS_APPLY%>");
                $("#partyApprovalBtn").prop("disabled",rowData.outStatus!="<%=MemberConstants.MEMBER_INFLOW_OUT_STATUS_BRANCH_VERIFY%>");
            }else{
    ...
    $("#jqGrid").navButtonAdd('#jqGridPager',{
        ...
        props:'data-url="${ctx}/memberInflowOut_check" data-querystr="&type=1" data-title="通过" data-msg="确定通过这{0}个申请吗？" data-callback="page_reload"'
    });
    </c:if>
    <c:if test="${cls==6}">
    $("#jqGrid").navButtonAdd('#jqGridPager',{
        ...
        buttonicon:"fa fa-check-circle-o",
        props:'data-url="${ctx}/memberInflowOut_check" data-querystr="&type=2" data-title="通过" data-msg="确定通过这{0}个申请吗？" data-callback="page_reload"'
    });
    </c:if>
