...
<ul class="nav nav-tabs" id="myTab2">
    <li class="${cls==1?'active':''}">
        <a href="javascript:;" class="loadPage" data-url="${ctx}/memberApply_layout?cls=1"><i class="fa fa-star"></i>
            党员发展</a>
    </li>
    <shiro:hasPermission name="applySnRange:*">
        <li class="dropdown <c:if test="${cls==6||cls==7}">active</c:if>">
            ...
            <ul class="dropdown-menu dropdown-info">
                <li>
                    <a href="javascript:;" class="loadPage" data-url="${ctx}/memberApply_layout?cls=6"><i
                            class="fa fa-hand-o-right"></i> 编码段管理</a>
                </li>
                <li role="separator" class="divider"></li>
                <li>
                    <a href="javascript:;" class="loadPage" data-url="${ctx}/memberApply_layout?cls=7"><i
                            class="fa fa-history"></i> 使用情况</a>
                </li>
            </ul>
        </li>
    </shiro:hasPermission>
    <shiro:hasPermission name="applySnRange:list">
        <li class="${cls==8?'active':''}">
            <a href="javascript:;" class="loadPage" data-url="${ctx}/memberApply_layout?cls=8"><i
                    class="fa fa-address-book-o"></i> 已分配志愿书编码</a>
        </li>
    </shiro:hasPermission>
    <shiro:hasPermission name="partyPublic:list">
        <li class="${cls==5?'active':''}">
            <a href="javascript:;" class="loadPage" data-url="${ctx}/memberApply_layout?cls=5"><i
                    class="fa fa-file-text"></i> 党员公示</a>
        </li>
    </shiro:hasPermission>
