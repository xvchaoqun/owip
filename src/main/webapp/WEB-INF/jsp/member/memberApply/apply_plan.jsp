...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/apply_plan" autocomplete="off" disableautocomplete id="applyForm" method="post">
        ...
        <c:if test="${count>1}">
			...
			<div class="form-group">
				<label class="col-xs-5 control-label"><span class="star">*</span>列入发展计划时间</label>
				<div class="col-xs-4">
                    <div class="input-group">
                        <input required class="form-control date-picker" name="_planTime" type="text"
