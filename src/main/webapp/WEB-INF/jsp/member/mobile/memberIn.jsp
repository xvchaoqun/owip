...
<div class="page-header">
    <h1>
        ...
        <a class="popupBtn btn btn-success btn-xs"
           data-width="800"
           data-url="${ctx}/m/hf_content?code=<%=SystemConstants.HTML_FRAGMENT_MEMBER_IN_NOTE_BACK%>">
            <i class="fa fa-info-circle"></i> 申请说明</a>
    </h1>
</div>
<form class="form-horizontal" action="${ctx}/m/memberIn" autocomplete="off" disableautocomplete id="modalForm"
      method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-6">
            <input required class="form-control left-input" byteMaxLength="20" maxlength="20" type="text" name="fromFax"
...
<script>
    ...
    var jqValid = $("#modalForm").validate({
