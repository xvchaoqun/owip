...
<div class="widget-box">
	...
	<div class="widget-body">
		<div class="widget-main">
			<form class="form-horizontal" action="${ctx}/user/memberOut_au" autocomplete="off" disableautocomplete id="updateForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
					...
					<div class="col-xs-5">
						...
						<div class="form-group">
							<label class="col-xs-8 control-label"><span class="star">*</span>转出单位联系电话</label>
							<div class="col-xs-4">
						...
						<div class="form-group">
							<label class="col-xs-8 control-label">转出单位传真</label>
							<div class="col-xs-4">
