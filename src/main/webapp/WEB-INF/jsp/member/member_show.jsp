        ...
        <div class="widget-box transparent" id="recent-box">
            <div class="widget-header">
                <h4 class="widget-title lighter smaller">
                    <i class="ace-icon fa fa-rss orange"></i>党员个人信息
                </h4>

                <div class="widget-toolbar no-border">
                    <ul class="nav nav-tabs" id="recent-tab">
                        <li class="active">
                            <a data-toggle="tab" href="#task-tab">基本信息</a>
                        </li>

                        <li>
                            <a data-toggle="tab" href="#member-tab">党籍信息</a>
                        </li>

                        <li>
                            <a data-toggle="tab" href="#comment-tab">学历信息</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#comment-tab">党内职务</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#comment-tab">行政职务</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#comment-tab">党内培训</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#comment-tab">出国信息</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#comment-tab">家庭信息</a>
                        </li>
                    </ul>
                </div>
            </div>
