...
<div class="modal-header">
    ...
    <h3>组织关系介绍信-${type==1?_p_partyName:'组织部'}审核</h3>
</div>
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/member/memberCertify_check"
		...
		<input type="hidden" name="ids[]" value="${param['ids[]']}">
			...
			<c:if test="${not empty memberCertify}">
			<div class="form-group">
				<label class="col-xs-4 control-label">姓名</label>
				<div class="col-xs-6 label-text">
					${memberCertify.user.realname}
				</div>
			</div>
			</c:if>
			<div class="form-group">
				<label class="col-xs-4 control-label"><span class="star">*</span> 审核</label>
				<div class="col-xs-6">
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
                        <textarea class="form-control limited" rows="3"
							   name="reason">${memberCertify.reason}</textarea>
				</div>
			</div>
    </form>
</div>
