                    ...
                    <div class="col-sm-12">
                        ...
                        <c:if test="${(branchCount)>0}">
                            <div class="infobox infobox-red"
                                 data-url="${ctx}/branch?isSearch=${isSearch}">
                                <div class="infobox-icon">
                                    <i class="ace-icon fa fa-sign-out"></i>
                                </div>
                                <div class="infobox-data">
                            ...
                            <div class="infobox infobox-pink">
                                ...
                                <div class="infobox-data">
                                    <span class="infobox-data-number">
                                        <span data-url="${ctx}/memberApply_layout?stage=${OW_APPLY_STAGE_DRAW}&type=${MEMBER_TYPE_STUDENT}&growStatus=-1">
                                            <span class="count">${studentGrowOdCheckCount}</span>
                                            <span style="font-size: 10pt;">学生</span>
                                        </span>
                                        <span data-url="${ctx}/memberApply_layout?stage=${OW_APPLY_STAGE_DRAW}&type=${MEMBER_TYPE_TEACHER}&growStatus=-1">
                        ...
                        <div class="infobox infobox-red">
                            ...
                            <div class="infobox-data">
                                <span class="infobox-data-number">
                                <span data-url="${ctx}/memberApply_layout?stage=${OW_APPLY_STAGE_GROW}&type=${MEMBER_TYPE_STUDENT}&positiveStatus=1">
                                <span class="count">${studentPositiveOdCheckCount}</span><span
                                        style="font-size: 10pt;">学生</span></span>
                                 <span data-url="${ctx}/memberApply_layout?stage=${OW_APPLY_STAGE_GROW}&type=${MEMBER_TYPE_TEACHER}&positiveStatus=1">
