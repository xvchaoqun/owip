                            ...
                            <div class="infobox infobox-pink">
                                ...
                                <div class="infobox-data">
                                    <span class="infobox-data-number">
                                        <span data-url="${ctx}/memberApply_layout?branchId=${param.branchId}&stage=${OW_APPLY_STAGE_DRAW}&type=${MEMBER_TYPE_STUDENT}&growStatus=-1">
                                            <span class="count">${studentGrowOdCheckCount}</span>
                                            <span style="font-size: 10pt;">学生</span>
                                        </span>
                                        <span data-url="${ctx}/memberApply_layout?branchId=${param.branchId}&stage=${OW_APPLY_STAGE_DRAW}&type=${MEMBER_TYPE_TEACHER}&growStatus=-1">
