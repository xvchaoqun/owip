...
<div class="col-sm-4" id="stat_branch_member_apply" style="width:350px;float: left;">
...
<script>
    $(function () {
        $("#stat_branch_member_apply ul li").click(function () {

            $.get("${ctx}/stat_branch_member_apply", {type: $(this).data('type')}, function (html) {
                $("#stat_branch_member_apply").replaceWith(html);
            });
        });
