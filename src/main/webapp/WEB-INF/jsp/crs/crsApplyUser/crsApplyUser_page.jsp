...
<div class="row">
    <div class="col-xs-12">
        <div id="body-content" class="rownumbers" data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            <c:set var="_query" value="${not empty param.postId || not empty param.code || not empty param.sort}"/>
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="crsApplyUser:edit">
                    <button class="popupBtn btn btn-info btn-sm"
                            data-url="${ctx}/crsApplyUser_au">
                ...
                <shiro:hasPermission name="crsApplyUser:del">
                ...
                <button class="jqExportBtn btn btn-success btn-sm tooltip-success"
                   data-url="${ctx}/crsApplyUser_data"
...
<script>
    $("#jqGrid").jqGrid({
        ...
        colModel: [
                { label: '报名人员',name: 'userId'},
                { label: '报名岗位',name: 'postId'},
                { label: '补报开始时间',name: 'startTime'},
                { label: '补报结束时间',name: 'endTime'},
