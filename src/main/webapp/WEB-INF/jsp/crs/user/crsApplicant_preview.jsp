            ...
            <div class="widget-body">
                            ...
                            <div style="float: left; margin-right: 20px; padding-bottom: 20px">
                                <table class="t1">
                                    ...
                                    <tr>
                                        <td colspan="13">
                                            <p class="p1">
                                                <span class="s1">${_school}干部应聘报名表</span>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="13">
                                            <p class="p2">
                                                <span class="bolder">应聘岗位：${crsApplicant.post.name}</span>
                                            </p>
                                        </td>
                                        <%--<td colspan="5">
                                    ...
                                    <tr class="r1">
                                        ...
                                        <td class="td6 center bolder" rowspan="4">
                                    ...
                                    <tr class="r1">
                                        ...
                                        <td class="td7 center" colspan="4">
                                            ${bean.proPost}${(not empty bean.proPost && not empty bean.proPostTime)?'<br/>':''}
                                            ${empty bean.proPostTime?"--":cm:formatDate(bean.proPostTime, "yyyy.MM")}
                                        </td>
                                        <td class="td4 center bolder" colspan="3">
                                            <span>管理岗位等级</span>
                                        ...
                                        <td class="td8 center" colspan="4">
                                            ${bean.manageLevel}${(not empty bean.manageLevel && not empty bean.manageLevelTime)?'<br/>':''}
                                            ${empty bean.manageLevelTime?"--":cm:formatDate(bean.manageLevelTime, "yyyy.MM")}
                                        </td>
                                    </tr>
                                    <tr class="r1">
                ...
                <span>
                    ${cm:getMetaType(bean.adminLevel).name}</span>
                                    ...
                                    <tr class="r2">
                                        ...
                                        <td class="td12 padding10" colspan="12">
                                            ${bean.parttime}
                                        </td>
                                    </tr>
                                    <tr class="r3">
                                        ...
                                        <td class="td12 padding10" colspan="12" style="vertical-align: top">
                                    ...
                                    <tr class="r3">
                                        ...
                                        <td class="td12 padding10" colspan="12" style="vertical-align: top">
                                            <pre class="pre">${crsApplicant.career}</pre>
                                        </td>
                                    </tr>
                                    <tr class="r3">
                            ...
                            <div style="padding-top: 91px">
                                <table class="t1">
                                    ...
                                    <tr class="r3">
                                        ...
                                        <td class="td12 padding10" colspan="12" style="vertical-align: top">
                                            <pre class="pre">${crsApplicant.report}</pre>
                                        </td>
                                    </tr>
                                    <tr class="r3">
                                        <td class="td1 bolder" style="height: 280px">
                                    ...
                                    <tr class="r4">
                                        ...
                                        <td class="td13 center bolder" colspan="6">
                                            <span>兼职（担任）单位及职务</span>
                                        </td>
                                        <td class="td2 center bolder" colspan="2">
                                            <span>兼职起始时间</span>
                                        </td>
                                        <td class="td14 center bolder" colspan="4">
                                            <span>审批单位</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="r4">
                                        ...
                                        <td class="td21 center bolder" colspan="4">
                                            <span>移居类别</span>
                                        </td>
                                        <td class="td22 center bolder">
                                            <span>移居时间</span>
                                        </td>
                                        <td class="td23 center bolder">
                                            <span>现居住城市</span>
                                        </td>
                                    </tr>
                                    <c:forEach items="${bean.cadreFamilyAbroads}" var="f">
                                        <tr class="r2">
                                            ...
                                            <td class="td20 center" colspan="3">
                                                    ${f.country}
                                            </td>
                                            <td class="td21 padding10" colspan="4">
                ...
                <span>长期居留许可 <input type="checkbox" style="vertical-align: -3px" disabled
                    ${cm:getMetaTypeByCode('mt_abroad_type_stay').id==f.type?'checked':''}/></span>
                                            ...
                                            <td class="td22 center">
                                                    ${cm:formatDate(f.abroadTime, "yyyy.MM")}
                                            </td>
                                            <td class="td23 center">
                                                    ${f.city}
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    <c:if test="${familyCount<=2}">
                                        ...
                                        <tr class="r2">
                                            ...
                                            <td class="td21 padding10" colspan="4">
                                                <span>外国国籍 <input type="checkbox" style="vertical-align: -3px"
                                                                  disabled/>  </span>

                                                <div>
                                                    <span>永久居留权 <input type="checkbox" style="vertical-align: -3px"
                                                                       disabled/></span>
                                                </div>
                                                <div>
                                                    <span>长期居留许可 <input type="checkbox" style="vertical-align: -3px"
                                                                        disabled/></span>
                                                </div>
                                            </td>
                                            <td class="td22">
