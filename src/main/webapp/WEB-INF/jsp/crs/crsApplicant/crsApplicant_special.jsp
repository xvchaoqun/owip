      ...
      <div class="widget-body">
        <div class="widget-main">
          <div id="dispatch-file-view">
            <c:import url="${ctx}/swf/preview?type=html&path=${crsApplicant.specialPdf}"/>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="au">
    <div id="dispatch-cadres-view">
      <div class="widget-box">
        ...
        <div class="widget-body">
          <div class="widget-main">
            <form class="form-horizontal" action="${ctx}/crsApplicant_special" id="modalForm" method="post"
