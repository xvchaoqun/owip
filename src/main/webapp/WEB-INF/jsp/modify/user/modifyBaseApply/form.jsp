...
<td rowspan="5" style="text-align: center;
        ...
        <tr>
          <td>政治面貌</td>
          <td>
              <c:set var="original" value="${cm:cadreParty(cadre.userId, cadre.isOw, cadre.owGrowTime, cadre.owPositiveTime, cadre.dpTypeId, cadre.dpGrowTime, false).get('partyName')}"/>
