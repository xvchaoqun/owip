            ...
            <div class="tabbable">
                ...
                <div class="jqgrid-vertical-offset buttons">
                        <a class="popupBtn btn btn-success btn-sm"
                           data-url="${ctx}/cadreResearch_au?toApply=1&cadreId=${cadre.id}&researchType=${researchType}"><i class="fa fa-plus"></i>
                            添加</a>
                        <a class="jqOpenViewBtn btn btn-primary btn-sm"
                           data-url="${ctx}/cadreResearch_au"
                           data-grid-id="#jqGrid_records"
                           data-querystr="&toApply=1&cadreId=${cadre.id}&researchType=${researchType}"><i class="fa fa-edit"></i>
                            修改</a>
