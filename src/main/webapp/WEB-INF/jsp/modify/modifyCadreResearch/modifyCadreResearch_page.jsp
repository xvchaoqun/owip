            ...
            <div class="tabbable">
                ...
                <div class="jqgrid-vertical-offset buttons">
                        <button class="popupBtn btn btn-success btn-sm"
                           data-url="${ctx}/cadreResearch_au?toApply=1&cadreId=${cadre.id}&module=${param.module}&researchType=${researchType}"><i class="fa fa-plus"></i>
                            添加</button>
                    ...
                    <input type="checkbox" data-name="${infoCheckName}" name="check" class="cadre-info-check"> 无此类情况
...
<script>
    $("#jqGrid_records").jqGrid({
        ...
        url: '${ctx}/cadreResearch_data?cadreId=${cadre.id}&researchType=${researchType}&${cm:encodeQueryString(pageContext.request.queryString)}',
