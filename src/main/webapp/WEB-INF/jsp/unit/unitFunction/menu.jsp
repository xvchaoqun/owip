...
<ul class="nav nav-tabs nav-justified">
	...
	<li class="<c:if test='${currentId == fun.id}'>active</c:if>" style="width: 120px">
		<a href="javascript:void(0)" class="reloadBtn ${fun.isCurrent?'green bolder':''}" data-target="#unitfunctionDiv"
	...
	<li class="<c:if test='${currentId==-1}'>active</c:if>" style="width: 100px">
		<a href="javascript:void(0)" class="reloadBtn" data-target="#unitfunctionDiv"
		   data-url="${ctx}/unitFunction?unitId=${unitId}&funId=-1"><i class="fa fa-plus"></i></a>
	</li>
</ul>
