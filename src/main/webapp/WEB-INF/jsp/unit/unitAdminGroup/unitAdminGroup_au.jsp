...
<div class="modal-header">
    ...
    <h3><c:if test="${unitAdminGroup!=null}">编辑</c:if><c:if test="${unitAdminGroup==null}">添加</c:if>行政班子</h3>
</div>
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/unitAdminGroup_au" id="modalForm" method="post">
        <input type="hidden" name="id" value="${unitAdminGroup.id}">
        <input type="hidden" name="unitId" value="${unit.id}">
        <div class="form-group">
            <label class="col-xs-3 control-label">所属单位</label>
            <div class="col-xs-6">
                <input type="text" disabled value="${unit.name}">
            </div>
        </div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
                        <input required class="form-control" type="text" name="name" value="${unitAdminGroup.name}">
				</div>
			</div>
			<div class="form-group">
            ...
            <div class="col-xs-6">
                <div class="input-group">
                    <input required class="form-control date-picker" name="_tranTime" type="text"
                           data-date-format="yyyy-mm-dd" value="${cm:formatDate(unitAdminGroup.tranTime,'yyyy-MM-dd')}" />
            ...
            <div class="col-xs-6">
                <div class="input-group">
                    <input class="form-control date-picker" name="_actualTranTime" type="text"
                           data-date-format="yyyy-mm-dd" value="${cm:formatDate(unitAdminGroup.actualTranTime,'yyyy-MM-dd')}" />
                    <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i></span>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-6">
                <div class="input-group">
                    <input required class="form-control date-picker" name="_appointTime" type="text"
                           data-date-format="yyyy-mm-dd" value="${cm:formatDate(unitAdminGroup.appointTime,'yyyy-MM-dd')}" />
                    <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i></span>
                </div>
            </div>
        </div>
...
<div class="modal-footer">
    ...
    <input type="submit" class="btn btn-primary" value="<c:if test="${unitAdminGroup!=null}">确定</c:if><c:if test="${unitAdminGroup==null}">添加</c:if>"/>
</div>
