                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <shiro:hasPermission name="unitTransfer:edit">
                                    <button onclick="_au(${unitTransfer.id})" class="editBtn btn btn-mini">
                                        <i class="fa fa-edit"></i> 编辑
                                    </button>
                                     </shiro:hasPermission>

                                        <button onclick="unitTransfer_addDispatchs(${unitTransfer.id})" class="btn btn-primary btn-mini">
                                            <i class="fa fa-file-o"></i> 相关发文
                                        </button>
                                     <shiro:hasPermission name="unitTransfer:del">
                                    <button class="btn btn-danger btn-mini" onclick="_del(${unitTransfer.id})">
...
<script>
    ...
    function _reload(){
        $("#modal").modal('hide');
        $("#view-box .tab-content").load("${ctx}/unitTransfer_page?${cm:escape(pageContext.request.queryString)}");
    }
