...
<c:if test="${isDispiayKeep}">
  ...
  <tr height=30>
    <td colspan=${isDispiayKeep?9:7} height=30 class=xl8324426 width=1068>
  ...
  <c:forEach items="${beans}" var="bean" varStatus="vs">
    <c:if test="${!vs.last}">
      <tr height=40 style='mso-height-source:userset;height:30.0pt'>
        ...
        <td width=57 class=${isDispiayKeep?'xl6424425':'xl6824425'} >
    ...
    <c:if test="${vs.last}">
      <tr height=40>
        ...
        <td width=57 class=${isDispiayKeep?'xl6424425':'xl6824425'}>${bean.mainLack}</td>
        ...
        <td width=57 class=${isDispiayKeep?'xl6424425':'xl6824425'}>${bean.viceLack}</td>
        <c:if test="${isDispiayKeep}">
          <td class=xl6924425 width=116>　</td>
