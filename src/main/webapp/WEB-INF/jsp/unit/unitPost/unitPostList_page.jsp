...
<ul class="jqgrid-vertical-offset nav nav-tabs padding-12 tab-color-blue background-blue">
    <li class="<c:if test="${cls==1}">active</c:if>">
        <a href="javascript:;" class="loadPage" data-load-el="#tab-content" data-url="${ctx}/unitPostList?cls=1"><i
                class="fa fa-circle-o-notch fa-spin"></i> 现有处级岗位</a>
    </li>
    <li class="<c:if test="${cls==2}">active</c:if>">
        <a href="javascript:;" class="loadPage" data-load-el="#tab-content" data-url="${ctx}/unitPostList?cls=2"><i class="fa fa-history"></i> 撤销处级岗位</a>
    </li>
</ul>
