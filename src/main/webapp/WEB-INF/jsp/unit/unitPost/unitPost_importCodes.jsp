...
<%@ include file="/WEB-INF/jsp/common/taglibs.jsp"%>         
  ...
  <div class="modal-body">
    <form class="form-horizontal" autocomplete="off" disableautocomplete id="modalForm" enctype="multipart/form-data"
		  action="${ctx}/unitPost_importCodes" method="post">
        ...
        <div class="well">
        <span class="help-inline">导入的文件请严格按照<a href="${ctx}/attach?code=sample_unitPostCodes">干部岗位批量更新编码录入样表.xlsx</a>（点击下载）的数据格式</span>
        </div>
  </div>
					...
					$(form).ajaxSubmit({
						...
						success:function(ret){
							if(ret && ret.successCount>=0){
								...
								var result = '导入完成，总共{0}条记录，其中成功更新{1}条记录';
