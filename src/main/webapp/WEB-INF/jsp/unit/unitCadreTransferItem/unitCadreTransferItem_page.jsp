                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <shiro:hasPermission name="unitCadreTransferItem:edit">
                                    <button data-id="${unitCadreTransferItem.id}" class="editBtn btn btn-default btn-mini btn-xs">
                                        <i class="fa fa-edit"></i> 编辑
                                    </button>
                                     </shiro:hasPermission>
                                     <shiro:hasPermission name="unitCadreTransferItem:del">
                                    <button class="delBtn btn btn-danger btn-mini btn-xs" data-id="${unitCadreTransferItem.id}">
