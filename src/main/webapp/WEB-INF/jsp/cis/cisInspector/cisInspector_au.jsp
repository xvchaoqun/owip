...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cisInspector_au" autocomplete="off" disableautocomplete id="modalForm" method="post">
        <input type="hidden" name="id" value="${cisInspector.id}">
			<div class="form-group">
				<label class="col-xs-3 control-label">请选择教职工</label>
				<div class="col-xs-6">
                    <select data-rel="select2-ajax" data-ajax-url="${ctx}/sysUser_selects?types=${USER_TYPE_JZG},${USER_TYPE_RETIRE}" data-width="350"
