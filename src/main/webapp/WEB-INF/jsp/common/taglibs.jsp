...
<c:set var="MODIFY_TABLE_APPLY_MODULE_CADRE_FAMLIY" value="<%=ModifyConstants.MODIFY_TABLE_APPLY_MODULE_CADRE_FAMLIY%>"/>
<c:set var="MODIFY_TABLE_APPLY_MODULE_CADRE_FAMLIYABROAD" value="<%=ModifyConstants.MODIFY_TABLE_APPLY_MODULE_CADRE_FAMLIYABROAD%>"/>
