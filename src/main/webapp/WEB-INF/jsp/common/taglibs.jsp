...
<c:set var="SYS_CONFIG_MEMBER_IN_NOTE_FRONT_TEACHER" value="<%=SystemConstants.SYS_CONFIG_MEMBER_IN_NOTE_FRONT_TEACHER%>"/>
<c:set var="SYS_CONFIG_MEMBER_IN_NOTE_FRONT_STUDENT" value="<%=SystemConstants.SYS_CONFIG_MEMBER_IN_NOTE_FRONT_STUDENT%>"/>
