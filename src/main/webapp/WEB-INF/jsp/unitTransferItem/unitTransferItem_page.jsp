...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="myTableDiv"
             data-url-au="${ctx}/unitTransferItem_au"
             data-url-page="${ctx}/unitTransferItem_page"
             data-url-del="${ctx}/unitTransferItem_del"
             data-url-bd="${ctx}/unitTransferItem_batchDel"
            ...
            <mytag:sort-form css="form-inline hidden-sm hidden-xs" id="searchForm">
                ...
                <c:set var="_query" value="${not empty param.transferId ||not empty param.dispatchUnitId || not empty param.code || not empty param.sort}"/>
                <c:if test="${_query}">
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <c:forEach items="${unitTransferItems}" var="unitTransferItem" varStatus="st">
                        <tr>
                            <td class="center">
                                <label class="pos-rel">
                                    <input type="checkbox" value="${unitTransferItem.id}" class="ace">
                                    <span class="lbl"></span>
                                </label>
                            </td>
								<td nowrap>${unitTransferItem.transferId}</td>
								<td nowrap>${unitTransferItem.dispatchUnitId}</td>
                            <shiro:hasPermission name="unitTransferItem:changeOrder">
                            <c:if test="${!_query && commonList.recNum>1}">
                                <td nowrap>
                            ...
                            <td nowrap>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <shiro:hasPermission name="unitTransferItem:edit">
                                    <button data-id="${unitTransferItem.id}" class="editBtn btn btn-mini">
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            ...
                                            <shiro:hasPermission name="unitTransferItem:edit">
                                            <li>
                                                <a href="#" data-id="${unitTransferItem.id}" class="editBtn tooltip-success" data-rel="tooltip" title="编辑">
                                                    <span class="green">
                    ...
                    <div class="row my_paginate_row">
                        ...
                        <div class="col-xs-6">
                            <div class="my_paginate">
                                <ul class="pagination">
                                    <wo:page commonList="${commonList}" uri="${ctx}/unitTransferItem_page" target="#page-content" pageNum="5"
                                             model="3"/>
                                </ul>
                            </div>
                        </div>
