    ...
    <form class="form-horizontal" action="${ctx}/dp/dpNpm_out" autocomplete="off" disableautocomplete id="modalForm" method="post">
		...
		<c:if test="${count>=1}">
			<div class="form-group">
				<label class="col-xs-3 control-label">退出的无党派人士</label>
		...
		<div class="form-group">
			<label class="col-xs-3 control-label"><span class="star">*</span> 退出时间</label>
			<div class="col-xs-6">
...
<div class="modal-footer">
    ...
    <button id="submitBtn"
            ...
            class="btn btn-primary"><i class="fa fa-check"></i> ${not empty dpNpm?'确定':'退出'}</button>
</div>
<script>
