    ...
    <div class="col-xs-12">
        <div id="body-content" class="rownumbers" data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            ...
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="dpOm:edit">
                    <c:if test="${cls==1}">
                    <button class="popupBtn btn btn-info btn-sm"
                            data-url="${ctx}/dp/dpOm_au">
                        ...
                        <form class="form-inline search-form" id="searchForm">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select data-rel="select2-ajax"
                                            data-ajax-url="${ctx}/dp/dpOm_selects?status=${_status}"
                            ...
                            <div class="form-group">
                                ...
                                <select data-width="180" name="type" data-rel="select2" data-placeholder="请选择">
                                    <option></option>
                                    <c:import url="/metaTypes?__id=${cm:getMetaClassByCode('mc_dp_other_type').id}"/>
                                </select>
                            ...
                            <c:if test="${cls==2}">
                                <div class="form-group">
                                    ...
                                    <div class="input-group tooltip-success" data-rel="tooltip" title="移除时间范围">
                                        ...
                                        <input placeholder="请选择移除时间范围" data-rel="date-range-picker" class="form-control date-range-picker" type="text" name="transferTime" value="${param.transferTime}"/>
                                    </div>
                                </div>
                            </c:if>
                            <div class="clearfix form-actions center">
                                <a class="jqSearchBtn btn btn-default btn-sm"
                                   data-url="${ctx}/dp/dpOm?cls=${cls}"
...
<script>
    ...
    $("#jqGrid").jqGrid({
        rownumbers:true,
        url: '${ctx}/dp/dpOm_data?callback=?&${cm:encodeQueryString(pageContext.request.queryString)}',
        colModel: [
