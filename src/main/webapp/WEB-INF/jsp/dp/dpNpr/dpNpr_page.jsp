...
<c:set var="DP_MEMBER_TYPE_NPR" value="<%=DpConstants.DP_MEMBER_TYPE_NPR%>"/>
<div class="row">
    <div class="col-xs-12">
        <div id="body-content" class="rownumbers" data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            ...
            ||not empty param.unitPost ||not empty param.gender ||not empty selectNations ||not empty param.unit}"/>
            <div class="tabbale">
            ...
            <div class="jqgrid-vertical-offset buttons">
                ...
                <c:if test="${cls==1}">
                    <a data-type="${DP_MEMBER_TYPE_NPR}" class="syncBtn btn btn-success btn-sm"
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
                    ...
                    formatoptions: {newformat: 'Y.m.d'}},
            {
                ...
                { label: '所属单位职务',name: 'unitPost',width:120,sortable:true},
