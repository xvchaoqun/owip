...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/dp/dpMember_changeDpParty" autocomplete="off" disableautocomplete id="modalForm" method="post">
        ...
        <div class="form-group">
            <label class="col-xs-3 control-label"><span class="star">*</span>转入民主党派</label>
            <div class="col-xs-9">
