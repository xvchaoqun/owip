...
<div class="top">
    <div class="w1000">
        <div class="logo"><img src="${ctx}/img/logo.png?_=${cm:lastModified(cm:getJsFilePath("login_bg.png"))}" /></div>
...
<div class="login_box ${sysConfig.displayLoginMsg?'':'no-msg'}">
    ...
    <div class="bg">
        <img src="${ctx}/img/login_bg.png?_=${cm:lastModified(cm:getJsFilePath("login_bg.png"))}" />
    </div>
