...
<ul class="jqgrid-vertical-offset nav nav-tabs padding-12 tab-color-blue background-blue">
    <li class="${type==1?"active":""}">
        <a href="javascript:;" onclick="_innerPage2(1)"><i class="fa fa-list"></i> 专技岗位过程信息</a>
    </li>
    <li class="${type==2?"active":""}">
        <a href="javascript:;" onclick="_innerPage2(2)"><i class="fa fa-list"></i> 管理岗位过程信息</a>
    </li>
    <li class="${type==3?"active":""}">
        <a href="javascript:;" onclick="_innerPage2(3)"><i class="fa fa-list"></i> 工勤岗位过程信息</a>
    </li>
