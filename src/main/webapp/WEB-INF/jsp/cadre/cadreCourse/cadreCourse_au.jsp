...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cadreCourse_au?toApply=${param.toApply}&cadreId=${cadre.id}" autocomplete="off" disableautocomplete id="modalForm" method="post">
