...
<ul class="jqgrid-vertical-offset nav nav-tabs padding-12 tab-color-blue background-blue">
    <li class="${type==1?"active":""}">
        <a href="javascript:;" onclick="_innerPage(1)"><i
                class="fa fa-check-square-o"></i> 干部考察报告</a>
    </li>
    <li class="${type==2?"active":""}">
        <a href="javascript:;" onclick="_innerPage(2)"><i class="fa fa-files-o"></i>
            现实表现材料和评价</a>
    </li>
    <li class="${type==3?"active":""}">
        <a href="javascript:;" onclick="_innerPage(3)"><i class="fa fa-list"></i>
            本人工作总结</a>
    </li>
</ul>
...
<script>
    function _innerPage(type, fn) {
        $("#view-box .tab-content").loadPage("${ctx}/cadreInspectInfo_page?cadreId=${param.cadreId}&type=" + type, null, fn)
    }
    <c:if test="${type==1}">
