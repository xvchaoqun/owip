...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cadrePostWork_au?cadreId=${cadre.id}" id="modalForm" method="post">
        ...
        <div class="form-group">
            <label class="col-xs-4 control-label">工勤岗位类型</label>

            <div class="col-xs-6">
                <select required data-rel="select2" name="type"
                        data-placeholder="请选择">
                    <option></option>
                    <c:import url="/metaTypes?__code=mc_post_work_type"/>
                </select>
                <script type="text/javascript">
                    $("#modal form select[name=type]").val(${cadrePostWork.type});
                </script>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-4 control-label">工勤岗位等级</label>

            <div class="col-xs-6">
                <select required data-rel="select2" name="level"
                        data-placeholder="请选择">
                    <option></option>
                    <c:import url="/metaTypes?__code=mc_post_work_level"/>
                </select>
                <script type="text/javascript">
            ...
            <div class="col-xs-6">
                <div class="input-group" style="width: 130px">
                    <input class="form-control date-picker" name="_gradeTime" type="text"
                           data-date-format="yyyy-mm-dd" value="${cm:formatDate(cadrePostWork.gradeTime,'yyyy-MM-dd')}"/>
