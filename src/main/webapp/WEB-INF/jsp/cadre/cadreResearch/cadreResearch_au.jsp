...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cadreResearch_au?toApply=${param.toApply}&cadreId=${cadre.id}" autocomplete="off" disableautocomplete id="modalForm" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <textarea required class="form-control" name="name">${cadreResearch.name}</textarea>
            ...
            $(form).ajaxSubmit({
                success:function(ret){
                    if(ret.success){
                        ...
                        $("#body-content-view").load("${ctx}/modifyTableApply_detail?applyId=${param.applyId}&researchType=${param.researchType}&module=${param.module}&opType=${param.opType}&_="+new Date().getTime())
                        </c:if>
                        <c:if test="${param._isUpdate!=1}">
