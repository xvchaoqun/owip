...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cadreCompany_au?toApply=${param.toApply}&cadreId=${cadre.id}" autocomplete="off" disableautocomplete id="modalForm" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label class="col-xs-3 control-label">批复日期</label>
            <div class="col-xs-6">
                <div class="input-group">
                    <input class="form-control date-picker" name="approvalDate" type="text"
                           data-date-format="yyyy-mm-dd" value="${cm:formatDate(cadreCompany.approvalDate,'yyyy-MM-dd')}" />
                    <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i></span>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-xs-3 control-label">所取酬劳是否全额上交学校</label>
            <div class="col-xs-6">
                <label>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="submitBtn"
            data-loading-text="<i class='fa fa-spinner fa-spin '></i> 提交中，请不要关闭此窗口"><c:if test="${cadreCompany!=null}">确定</c:if><c:if test="${cadreCompany==null}">添加</c:if></button>
</div>
