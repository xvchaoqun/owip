            ...
            <div class="col-xs-7">
                <form class="form-horizontal"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <select data-rel="select2" name="politicalStatus" data-placeholder="请选择"
                                    data-width="125">
                                <option></option>
...
<script>
    ...
    $('#modalForm select[name=title]').change(function () {
        ...
        switch ($option.data('extra-attr')) {
            case 'zb':// 父亲或母亲
                hint = "请填写父亲、母亲现工作的单位、部门及职务。如果父亲或母亲已退休或者已去世，请填写退休前的单位、部门及职务。退休请注明（已退休），去世请注明（已去世）”。示例：“**省**市教育局**科**科长（已退休）";
                break;
            case 'po':
