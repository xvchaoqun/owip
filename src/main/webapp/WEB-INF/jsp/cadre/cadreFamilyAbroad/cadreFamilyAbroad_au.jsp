...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/cadreFamilyAbroad_au?toApply=${param.toApply}&cadreId=${cadre.id}"
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <select required data-rel="select2-ajax" data-width="273"
                        data-ajax-url="${ctx}/cadreFamily_selects?cadreId=${cadre.id}" name="familyId"
        ...
        <div class="form-group">
            <label class="col-xs-3 control-label"><span class="star">*</span>移居国家（地区）</label>
            <div class="col-xs-6">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <textarea class="form-control limited" name="remark">${cadreFamilyAbroad.remark}</textarea>
            </div>
        </div>
    </form>
</div>
<div class="modal-footer">
    ...
    <input type="submit" class="btn btn-primary"
           value="<c:if test="${cadreFamilyAbroad!=null}">确定</c:if><c:if test="${cadreFamilyAbroad==null}">添加</c:if>"/>
</div>
