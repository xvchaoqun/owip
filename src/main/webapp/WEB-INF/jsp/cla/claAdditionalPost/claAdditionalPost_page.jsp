...
<div class="row">
    <div class="col-xs-12">
        <div id="body-content" class="myTableDiv"
             data-url-au="${ctx}/cla/claAdditionalPost_au"
             data-url-page="${ctx}/cla/claAdditionalPost"
             data-url-export="${ctx}/cla/claAdditionalPost_data"
             data-url-co="${ctx}/cla/claAdditionalPost_changeOrder"
            ...
            || (not empty param.sort&&param.sort!='sort_order')}"/>
                <div class="jqgrid-vertical-offset buttons">
                    <shiro:hasPermission name="claAdditionalPost:edit">
