...
<%@ include file="/WEB-INF/jsp/common/taglibs.jsp"%>         
  ...
  <form class="form-horizontal"  action="${ctx}/cla/claApplicatType/selectCadres" autocomplete="off" disableautocomplete id="modalForm" method="post">
  ...
  <script>
	...
	$(function(){
		$.getJSON("${ctx}/cla/claApplicatType/selectCadres_tree",{id:"${param.id}"},function(data){
