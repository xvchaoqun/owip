...
<div class="modal-body">
    ...
    注：干部请假申请审批时，审批顺序由上至下
    <div class="popTableDiv"
         data-url-page="${ctx}/cla/claApplicatType/claApprovalOrder?id=${applicatType.id}"
         data-url-del="${ctx}/cla/claApplicatType/claApprovalOrder_del"
         data-url-co="${ctx}/cla/claApplicatType/claApprovalOrder_changeOrder?applicatTypeId=${applicatType.id}">
            ...
            <table class="table table-actived table-striped table-bordered table-hover">
                ...
                <c:forEach items="${approvalOrders}" var="approvalOrder" varStatus="st">
                    ...
                    <c:if test="${!empty commonList && commonList.pageNum>1 }">
                        <wo:page commonList="${commonList}" uri="${ctx}/cla/claApplicatType/claApprovalOrder" target="#modal .modal-content"
                                 pageNum="5"
                                 model="3"/>
                    </c:if>
        </c:if>
