...
<script>
    ...
    $("#jqGrid2").jqGrid({
        ...
        colModel: [
            ...
            { label: '申请日期', name: 'applyDate',frozen:true, formatter: $.jgrid.formatter.date,
                formatoptions: {newformat: 'Y.m.d'} },
            { label: '出发时间', name: 'startTime', width: 150, formatter: $.jgrid.formatter.date,
                formatoptions: {srcformat:'Y-m-d H:i:s', newformat: 'Y-m-d H:i'} },
            { label: '返回时间', name: 'endTime', width: 150, formatter: $.jgrid.formatter.date,
                formatoptions: {srcformat:'Y-m-d H:i:s',newformat: 'Y-m-d H:i'} },
