...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="myTableDiv"
             data-url-au="${ctx}/cla/claApproverType_au"
             data-url-page="${ctx}/cla/claApproverType"
             data-url-del="${ctx}/cla/claApproverType_del"
             data-url-bd="${ctx}/cla/claApproverType_batchDel"
             data-url-co="${ctx}/cla/claApproverType_changeOrder"
            ...
            <c:if test="${commonList.recNum>0}">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach items="${approverTypes}" var="approverType" varStatus="st">
                        <tr>
								...
								<td>${CLA_APPROVER_TYPE_MAP.get(approverType.type)}</td>
								<td>
                                    <c:if test="${approverType.type==CLA_APPROVER_TYPE_UNIT || approverType.type==CLA_APPROVER_TYPE_LEADER}">
                                        <button data-url="${ctx}/cla/claApproverType/selectCadres?type=${approverType.type}"
                                    ...
                                    <c:if test="${approverType.type!=CLA_APPROVER_TYPE_UNIT && approverType.type!=CLA_APPROVER_TYPE_LEADER}">
                                    <button data-url="${ctx}/cla/claApproverType/selectCadres?type=${approverType.type}&id=${approverType.id}"
                ...
                <wo:page commonList="${commonList}" uri="${ctx}/cla/claApproverType" target="#page-content" pageNum="5"
                         model="3"/>
            </c:if>
            <c:if test="${commonList.recNum==0}">
