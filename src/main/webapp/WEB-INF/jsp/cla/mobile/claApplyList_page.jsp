            ...
            <div class="tab-content" style="padding: 0px;">
                <div class="tab-pane in active">
                    <div class="message-list-container">
                        <div class="message-list">
                            ...
                            <div class="openView message-item" data-open-by="page"
                                 data-url="${ctx}/m/cla/claApply_view?id=${claApply.id}&status=${status}">
                                ...
                                <span class="summary">
                                    <span class="text">
                                        ...
                                        ${cm:formatDate(claApply.startTime,'MM.dd HH:mm')}~${cm:formatDate(claApply.endTime,'MM.dd HH:mm')}，
                    ...
                    <div class="message-footer clearfix">
                        <wo:page commonList="${commonList}" uri="${ctx}/m/cla/claApplyList_page" target="#page-content" model="4"/>
                    </div>
                </div>
            </div>
        </div>
