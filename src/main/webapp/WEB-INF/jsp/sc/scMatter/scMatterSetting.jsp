          ...
          <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${cm:getMetaTypes(metaClass.code)}" var="entity" varStatus="vs">
              ...
              <tr>
                ...
                <td nowrap>
                  <a href="javascript:;" data-url="${ctx}/sc/scMatterSetting_changeOrder"
                ...
                <td>
                  <a class="popupBtn btn btn-primary btn-xs"
                     data-url="${ctx}/sc/scMatterSetting_au?id=${record.id}"><i class="fa fa-edit"></i>
                    修改</a>
                  <button class="confirm btn btn-danger btn-xs"
                          data-url="${ctx}/sc/scMatterSetting_del?id=${record.id}"
                          data-title="删除"
