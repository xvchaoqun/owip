...
<div class="row">
    <div class="col-xs-12">
        <div id="body-content" class="rownumbers" data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            <c:set var="_query" value="${not empty param.year ||not empty param.hrType ||not empty param.hrNum || not empty param.code || not empty param.sort}"/>
...
<script>
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '任免日期', name: 'dispatch.workTime', formatter: 'date', formatoptions: {newformat: 'Y-m-d'}},
