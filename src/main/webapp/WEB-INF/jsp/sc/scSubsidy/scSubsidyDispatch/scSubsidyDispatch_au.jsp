...
<div class="modal-footer">
    ...
    <button id="submitBtn" class="btn btn-primary"><i class="fa fa-check"></i> <c:if test="${scSubsidyDispatch!=null}">确定</c:if><c:if test="${scSubsidyDispatch==null}">添加</c:if></button>
</div>
<script>
