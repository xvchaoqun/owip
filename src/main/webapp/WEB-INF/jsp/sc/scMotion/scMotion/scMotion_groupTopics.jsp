...
<jsp:include page="/WEB-INF/jsp/sc/scGroup/scGroupTopic/scGroupTopic_colModel.jsp"/>
<script>
    ...
    $jqGrid.jqGrid({
        ...
        url: "${ctx}/sc/scGroupTopic_data?callback=?&unitIds=${unitPost.unitId}&popup=1&${cm:encodeQueryString(pageContext.request.queryString)}",
        colModel: colModel,
