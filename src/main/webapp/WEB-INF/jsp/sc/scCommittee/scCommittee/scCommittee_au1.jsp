						...
						<form class="form-horizontal" action="${ctx}/sc/scCommittee_au" id="committeeForm" method="post"
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-xs-8">
										<select data-rel="select2-ajax" data-ajax-url="${ctx}/cadre_selects?key=1&isCommittee=1"
...
<script>
	...
	function _selectUser(isAbsent) {
		...
		var title = $select.select2("data")[0]['title'] || '';
		var user = {userId: userId, realname: realname, code: code, title:title, isAbsent:(isAbsent==1)};
