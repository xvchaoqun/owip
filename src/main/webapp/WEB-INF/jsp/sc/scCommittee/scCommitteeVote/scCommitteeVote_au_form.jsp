        ...
        <div class="row">
          <div class="col-xs-6">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-8">
                <input disabled class="form-control" type="text" name="_name" value="${scCommitteeVote.user.realname}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-6">
                <select class="form-control" data-rel="select2" data-width="220" name="procedureId" data-placeholder="请选择任免程序">
                  <option></option>
            ...
            <div class="form-group">
              ...
              <div class="col-xs-8">
                <textarea class="form-control limited" name="remark" rows="2">${scCommitteeVote.remark}</textarea>
              </div>
            </div>
          </div>
          <div class="col-xs-6">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-7">
                <input class="form-control" name="_unitType" type="text" disabled value="${scCommitteeVote.unit.unitType.name}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-5">
                <input required class="form-control num" type="text" name="aggreeCount" value="${scCommitteeVote.aggreeCount}">
              </div>
            </div>
...
<script>
  ...
  $("#voteForm button[type=submit]").click(function(){$("#voteForm").submit();return false;});
  $("#voteForm").validate({
  ...
  var $selectCadre = register_user_select($('#voteForm select[name=cadreId]'),function(state){ var $state = state.text;
