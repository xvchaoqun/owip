...
<div class="row">
    <div class="col-xs-12">
        <div id="body-content" class="rownumbers" data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            <c:set var="_query" value="${not empty param.teamId ||not empty param.unitId ||not empty param.confirmDate || not empty param.code || not empty param.sort}"/>
