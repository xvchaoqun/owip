...
<div class="row">
    <div class="col-xs-12">
        <div id="body-content" class="rownumbers" data-querystr="${cm:encodeQueryString(pageContext.request.queryString)}">
            <c:set var="_query" value="${not empty param.unitId ||not empty param.userId ||not empty param.isCadre || not empty param.code || not empty param.sort}"/>
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="sp:edit">
                    <button class="popupBtn btn btn-info btn-sm"
                            data-url="${ctx}/sp/spRetire_au">
                ...
                <shiro:hasPermission name="sp:edit">
                    <button data-url="${ctx}/sp/spRetire_batchDel"
                            data-title="删除"
