                        ...
                        <div class="clearfix form-actions center">
                            ...
                            <c:choose>
                                <c:when test="${memberApply.stage==APPLY_STAGE_INIT}">
                                    <button onclick="apply_pass(${memberApply.userId}, 1)" class="btn btn-success">
                                ...
                                <c:when test="${memberApply.stage==APPLY_STAGE_PASS}">
                                    <button onclick="apply_active(${memberApply.userId}, 1)" class="btn btn-success">
                                ...
                                <c:when test="${memberApply.stage==APPLY_STAGE_ACTIVE}">
                                    <c:if test="${empty memberApply.candidateStatus}">
                                        <button onclick="apply_candidate(${memberApply.userId}, 1)" class="btn btn-success">
                                            <i class="fa fa-check"></i> 确定为发展对象
                                        </button>
                                    </c:if>
                                    <c:if test="${memberApply.candidateStatus==0}">
                                        <button onclick="apply_candidate_check(${memberApply.userId}, 1)" class="btn btn-success">
                                ...
                                <c:when test="${memberApply.stage==APPLY_STAGE_CANDIDATE}">
                                    <c:if test="${empty memberApply.planStatus}">
                                        <button onclick="apply_plan(${memberApply.userId}, 1)" class="btn btn-success">
                                ...
                                <c:when test="${memberApply.stage==APPLY_STAGE_PLAN}">
                                    <c:if test="${empty memberApply.drawStatus}">
                                        <button onclick="apply_draw(${memberApply.userId}, 1)" class="btn btn-success">
                                            <i class="fa fa-check"></i> 领取志愿书
                                        </button>
                                    </c:if>
                                    <c:if test="${memberApply.drawStatus==0}">
                                        <button onclick="apply_draw_check(${memberApply.userId}, 1)" class="btn btn-success">
                                            <i class="fa fa-check"></i> 审核
                                        </button>
                                    </c:if>
                                </c:when>
                                <c:when test="${memberApply.stage==APPLY_STAGE_DRAW}">
                                    <c:if test="${empty memberApply.growStatus}">
                                        <button onclick="apply_grow(${memberApply.userId}, 1)" class="btn btn-success">
                                ...
                                <c:when test="${memberApply.stage==APPLY_STAGE_GROW}">
                                    <c:if test="${empty memberApply.positiveStatus}">
                                        <button onclick="apply_positive(${memberApply.userId}, 1)" class="btn btn-success">
