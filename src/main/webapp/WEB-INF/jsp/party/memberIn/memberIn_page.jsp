...
<c:if test="${cls!=3}">
    ...
    $("#jqGrid").navButtonAdd('#jqGridPager',{
        ...
        props:'data-url="${ctx}/memberIn_check" data-querystr="&type=1" data-title="通过" data-msg="确定通过这{0}个申请吗？" data-callback="page_reload"'
    });
    <shiro:hasRole name="odAdmin">
    $("#jqGrid").navButtonAdd('#jqGridPager',{
        caption:"组织部批量审核",
        ...
        buttonicon:"fa fa-check-circle-o",
        props:'data-url="${ctx}/memberIn_check" data-querystr="&type=2" data-title="通过" data-msg="确定通过这{0}个申请吗？" data-callback="page_reload"'
    });
    </shiro:hasRole>
