...
<%@ include file="/WEB-INF/jsp/common/taglibs.jsp"%>         
  ...
  <div class="modal-body">
    <form class="form-horizontal" autocomplete="off" disableautocomplete id="modalForm"
          enctype="multipart/form-data" action="${ctx}/branchMember_import" method="post">
        ...
        <div class="well">
        <span class="help-inline">导入的文件请严格按照<a href="${ctx}/attach?code=sample_branchMember">党支部委员会成员录入样表.xlsx</a>（点击下载）的数据格式</span>
        </div>
  </div>
  <div class="modal-footer">
      <div class="note">注：此处仅导入已设定现任支部委员会的相关委员会成员</div>
