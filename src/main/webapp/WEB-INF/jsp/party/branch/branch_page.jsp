    ...
    <div class="col-xs-12">
        ...
        <div class="myTableDiv"
            ...
            <mytag:sort-form css="form-inline hidden-sm hidden-xs" id="searchForm">
                ...
                <input class="form-control search-query" name="foundTime" type="text" value="${param.foundTime}"
                       placeholder="请输入成立时间">
                <a class="searchBtn btn btn-sm"><i class="fa fa-search"></i> 查找</a>
                <c:set var="_query" value="${not empty param.code ||not empty param.name ||not empty param.partyId ||not empty param.typeId ||not empty param.unitTypeId ||not empty param.foundTime || not empty param.code || not empty param.sort}"/>
                <c:if test="${_query}">
