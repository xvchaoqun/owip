...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/graduateAbroad_transfer_au" id="modalForm" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input required class="form-control" type="text" name="orgBranchAdminPhone" value="${graduateAbroad.orgBranchAdminPhone}">
            </div>
        </div>
    </form>
</div>
