                        ...
                        <tr>
                            ...
                            <%--<td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <shiro:hasPermission name="memberAbroad:edit">
                                    <button data-id="${memberAbroad.userId}" class="editBtn btn btn-default btn-mini btn-xs">
                                        <i class="fa fa-edit"></i> 编辑
                                    </button>
                                     </shiro:hasPermission>
                                     <shiro:hasPermission name="memberAbroad:del">
                                    <button class="delBtn btn btn-danger btn-mini btn-xs" data-id="${memberAbroad.userId}">
