...
<ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
  ...
  <a href="javascript:;" class="renderBtn" data-url="${ctx}/member?cls=1"}><i class="fa fa-th${cls==1?'-large':''}"></i> 学生党员</a>
  </li>
  <li class="${cls==2?'active':''}">
  <a href="javascript:;" class="renderBtn" data-url="${ctx}/member?cls=2"}><i class="fa fa-th${cls==2?'-large':''}"></i> 在职教职工党员</a>
  </li>
  <li class="${cls==3?'active':''}">
  <a href="javascript:;" class="renderBtn" data-url="${ctx}/member?cls=3"}><i class="fa fa-th${cls==3?'-large':''}"></i> 离退休党员</a>
  </li>
  ...
  <li class="dropdown <c:if test="${cls==6||cls==7}">active</c:if>" >
    ...
    <ul class="dropdown-menu dropdown-info" style="min-width: 100px">
      <li>
        <a href="javascript:;" class="renderBtn" data-url="${ctx}/member?cls=6">学生</a>
      </li>
      <li>
        <a href="javascript:;" class="renderBtn" data-url="${ctx}/member?cls=7">教职工</a>
      </li>
    </ul>
  </li>
