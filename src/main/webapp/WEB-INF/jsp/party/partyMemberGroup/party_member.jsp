                    ...
                    <tr>
                        ...
                        <td nowrap>
                            <div class="hidden-sm hidden-xs action-buttons">
                                <shiro:hasPermission name="partyMember:edit">
                                    <c:if test="${!partyMember.isAdmin}">
                                        <button class="adminBtn btn btn-success btn-xs" data-id="${partyMember.id}">
                                            <i class="fa fa-trash"></i> 设为管理员
                                        </button>
                                    </c:if>
                                    <c:if test="${partyMember.isAdmin}">
                                        <button class="adminBtn btn btn-danger btn-xs" data-id="${partyMember.id}">
                                            <i class="fa fa-trash"></i> 删除管理员
                                        </button>
                                    </c:if>
                                </shiro:hasPermission>
                                <shiro:hasPermission name="partyMember:del">
                                    <button class="delBtn btn btn-danger btn-xs" data-id="${partyMember.id}">
