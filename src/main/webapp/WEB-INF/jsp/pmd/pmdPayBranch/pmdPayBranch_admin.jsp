...
<div class="modal-header">
    ...
    <h3>${branch!=null?branch.name:''}-设定管理员</h3>
</div>
<div class="modal-body">
        <div class="widget-box">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal no-footer" action="${ctx}/pmd/pmdBranchAdmin_add" autocomplete="off" disableautocomplete id="modalForm" method="post">
    ...
    <div class="popTableDiv"
         data-url-page="${ctx}/pmd/pmdBranchAdmin?branchId=${branch.id}"
         data-url-del="${ctx}/pmd/pmdBranchAdmin_del">
            ...
            <table class="table table-actived table-striped table-bordered table-hover">
                ...
                <tbody>
                <c:forEach items="${branchAdmins}" var="admin" varStatus="st">
