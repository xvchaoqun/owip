...
<div class="row">
    <div class="col-xs-12">
        ...
        <div id="body-content" class="myTableDiv"
                 data-url-page="${ctx}/trainEvaNorm_page"
                 data-url-export="${ctx}/trainEvaNorm_data"
            ...
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="trainEvaNorm:edit">
                    <a class="popupBtn btn btn-info btn-sm"  data-url="${ctx}/trainEvaNorm_au"><i class="fa fa-plus"></i> 添加</a>
