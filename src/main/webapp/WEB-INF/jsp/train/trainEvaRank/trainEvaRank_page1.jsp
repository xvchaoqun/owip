...
<div class="row">
    <div class="col-xs-12">
        ...
        <div id="body-content" class="myTableDiv"
                 data-url-page="${ctx}/trainEvaRank_page"
                 data-url-export="${ctx}/trainEvaRank_data"
            ...
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="trainEvaRank:edit">
                    <a class="popupBtn btn btn-info btn-sm"  data-url="${ctx}/trainEvaRank_au"><i class="fa fa-plus"></i> 添加</a>
...
<script>
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            { label: '所属评估表',name: 'evaTableId'},
            { label: '名称',name: 'name'},
            { label: '得分',name: 'score'},
            { label: '得分显示内容',name: 'scoreShow'},
