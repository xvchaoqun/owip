...
<div class="modal-header">
    ...
    <h3 style="margin: 0">从本届党委委员库中提取</h3>
</div>
...
<script>
    $("#jqGrid_popup").jqGrid({
        ...
        url: "${ctx}/cmMember_data?callback=?&configId=${configId}&type=${CM_MEMBER_TYPE_DW}&isQuit=0&${cm:encodeQueryString(pageContext.request.queryString)}",
        colModel: [
    ...
    $("#selectBtn").click(function () {
        ...
        $.post("${ctx}/cmMember_draw", {memberIds:memberIds},function(ret){
            if(ret.success){
                $("#modal").modal('hide');
