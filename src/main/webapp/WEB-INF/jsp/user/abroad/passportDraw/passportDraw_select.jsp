    ...
    <form class="form-horizontal">
        ...
        <div class="well">
            <blockquote>
                ...
                <button ${fn:length(passports)==0?"disabled":""} onclick="location.href='${ctx}/user/passportDraw_tw'" class="btn ${fn:length(passports)==0?"btn-default":"btn-warning"}" type="button">
                    <i class="ace-icon fa fa-forward bigger-110"></i>
                    进入
                </button></blockquote>
        </div>
