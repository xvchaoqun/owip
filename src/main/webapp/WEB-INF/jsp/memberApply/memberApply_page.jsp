        ...
        <div class="myTableDiv"
            ...
            <mytag:sort-form css="form-inline hidden-sm hidden-xs" id="searchForm">
                ...
                <div class="buttons pull-right">
                    <shiro:hasPermission name="memberApply:edit">
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tr>
                        <th class="center">
							...
							<th>所属党支部</th>
							<th>类型</th>
                        <shiro:hasPermission name="memberApply:changeOrder">
                    ...
                    <c:forEach items="${memberApplys}" var="memberApply" varStatus="st">
                        <tr>
                            <td class="center">
                                <label class="pos-rel">
                                    <input type="checkbox" value="${memberApply.id}" class="ace">
                                    <span class="lbl"></span>
                                </label>
                            </td>
								<td>${memberApply.userId}</td>
								<td>${memberApply.partyId}</td>
								<td>${memberApply.branchId}</td>
								<td>${memberApply.type}</td>
                            <shiro:hasPermission name="memberApply:changeOrder">
                            <c:if test="${!_query && commonList.recNum>1}">
                                <td class="hidden-480">
                                    <a href="#" <c:if test="${commonList.pageNo==1 && st.first}">style="visibility: hidden"</c:if> class="changeOrderBtn" data-id="${memberApply.id}" data-direction="1" title="上升"><i class="fa fa-arrow-up"></i></a>
                                    <input type="text" value="1"
                                           class="order-step tooltip-success" data-rel="tooltip" data-placement="top" title="修改操作步长">
                                    <a href="#" <c:if test="${commonList.pageNo>=commonList.pageNum && st.last}">style="visibility: hidden"</c:if> class="changeOrderBtn" data-id="${memberApply.id}" data-direction="-1" title="下降"><i class="fa fa-arrow-down"></i></a>                                </td>
                                </td>
                            </c:if>
                            </shiro:hasPermission>
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <shiro:hasPermission name="memberApply:edit">
                                    <button data-id="${memberApply.id}" class="editBtn btn btn-mini">
                                        <i class="fa fa-edit"></i> 编辑
                                    </button>
                                     </shiro:hasPermission>
                                     <shiro:hasPermission name="memberApply:del">
                                    <button class="delBtn btn btn-danger btn-mini" data-id="${memberApply.id}">
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            ...
                                            <shiro:hasPermission name="memberApply:edit">
                                            <li>
                                                <a href="#" data-id="${memberApply.id}" class="editBtn tooltip-success" data-rel="tooltip" title="编辑">
                                                    <span class="green">
                                            ...
                                            <shiro:hasPermission name="memberApply:del">
                                            <li>
                                                <a href="#" data-id="${memberApply.id}" class="delBtn tooltip-error" data-rel="tooltip" title="删除">
                                                    <span class="red">
