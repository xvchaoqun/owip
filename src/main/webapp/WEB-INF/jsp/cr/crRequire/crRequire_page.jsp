...
<div class="row">
    <div class="col-xs-12">
        ...
        <div id="body-content" class="myTableDiv"
                 data-url-page="${ctx}/crRequire"
                 data-url-export="${ctx}/crRequire_data"
            ...
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="crRequire:edit">
                    <a class="popupBtn btn btn-info btn-sm"  data-url="${ctx}/crRequire_au"><i class="fa fa-plus"></i> 添加</a>
                    <a class="jqOpenViewBtn btn btn-primary btn-sm"
                       data-url="${ctx}/crRequire_au"
                       data-grid-id="#jqGrid"
                       ><i class="fa fa-edit"></i>
                        修改</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="crRequire:del">
                    <button data-url="${ctx}/crRequire_batchDel"
                            data-title="删除"
...
<script>
    $("#jqGrid").jqGrid({
        url: '${ctx}/crRequire_data?callback=?&${cm:encodeQueryString(pageContext.request.queryString)}',
        colModel: [
            { label: '模板名称',name: 'name', width: 400, align:'left', frozen: true},

            {
                label: '排序', width: 90, formatter: $.jgrid.formatter.sortOrder,
                formatoptions:{url: "${ctx}/crRequire_changeOrder"}, frozen: true
            },
            ...
            {label: '预览', name: 'rankNum', formatter: function (cellvalue, options, rowObject) {
                ...
                return '<a href="javascript:void(0)" class="popupBtn" data-url="${ctx}/crRequire_preview?id={0}">预览</a>'
                        .format(rowObject.id);
            }, width: 80},
