...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="myTableDiv"
             data-url-au="${ctx}/cadreCompany_au"
             data-url-page="${ctx}/cadreCompany_page"
             data-url-del="${ctx}/cadreCompany_del"
             data-url-bd="${ctx}/cadreCompany_batchDel"
             data-url-co="${ctx}/cadreCompany_changeOrder"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <shiro:hasPermission name="cadreCompany:edit">
                                    <button data-id="${cadreCompany.id}" class="editBtn btn btn-mini">
                                        <i class="fa fa-edit"></i> 编辑
                                    </button>
                                     </shiro:hasPermission>
                                     <shiro:hasPermission name="cadreCompany:del">
                                    <button class="delBtn btn btn-danger btn-mini" data-id="${cadreCompany.id}">
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            ...
                                            <shiro:hasPermission name="cadreCompany:edit">
                                            <li>
                                                <a href="#" data-id="${cadreCompany.id}" class="editBtn tooltip-success" data-rel="tooltip" title="编辑">
                                                    <span class="green">
                                            ...
                                            <shiro:hasPermission name="cadreCompany:del">
                                            <li>
                                                <a href="#" data-id="${cadreCompany.id}" class="delBtn tooltip-error" data-rel="tooltip" title="删除">
                                                    <span class="red">
                    ...
                    <div class="row my_paginate_row">
                        ...
                        <div class="col-xs-6">
                            <div class="my_paginate">
                                <ul class="pagination">
                                    <wo:page commonList="${commonList}" uri="${ctx}/cadreCompany_page" target="#page-content" pageNum="5"
                                             model="3"/>
                                </ul>
                            </div>
                        </div>
