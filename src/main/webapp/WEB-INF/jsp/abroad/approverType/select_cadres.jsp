...
<%@ include file="/WEB-INF/jsp/common/taglibs.jsp"%>         
  <div class="modal-header">
    ...
    <h4>"${approverType.name}"所包含的干部
    </h4>
  </div>
  <div class="modal-body">
  <form class="form-horizontal"  action="${ctx}/approverType/select_cadres" id="modalFrom" method="post">
  <div id="tree3"></div>
  </form>
  </div>
  ...
  <script>
	...
	$(function(){
		$.getJSON("${ctx}/approverType/selectCadres_tree",{id:"${param.id}"},function(data){
