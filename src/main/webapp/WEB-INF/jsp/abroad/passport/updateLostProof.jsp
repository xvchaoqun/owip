...
<div class="modal-body">
    <form class="form-horizontal" action="${ctx}/abroad/updateLostProof" autocomplete="off" disableautocomplete id="modalForm" method="post" enctype="multipart/form-data">
