...
<li  class="<c:if test="${status==1}">active</c:if>">
    <a href="javascript:;" class="loadPage" data-url="${ctx}/abroad/passport?status=1"><i class="fa fa-circle-o"></i> 集中管理证件</a>
</li>
<li class="dropdown <c:if test="${status==2||status==4}">active</c:if>" >
    ...
    <ul class="dropdown-menu dropdown-info" style="min-width: 230px">
        <li>
            <a href="javascript:;" class="loadPage" data-url="${ctx}/abroad/passport?status=2">未确认</a>
        </li>
        <li>
            <a href="javascript:;" class="loadPage" data-url="${ctx}/abroad/passport?status=4">已确认</a>
        </li>
    </ul>
</li>
...
<a href="javascript:;" class="loadPage" data-url="${ctx}/abroad/passport?status=3"><i class="fa fa-times"></i> 丢失的证件</a>
</li>
