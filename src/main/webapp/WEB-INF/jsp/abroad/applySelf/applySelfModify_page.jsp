...
<script>
  ...
  $("#jqGrid2").jqGrid({
    ...
    colModel: [
      ...
      { label: '出行时间',  name: 'startDate',cellattr:cellattr, formatter: 'date', formatoptions: {newformat: 'Y-m-d'} },
      { label: '回国时间',  name: 'endDate' ,cellattr:cellattr, formatter: 'date', formatoptions: {newformat: 'Y-m-d'}},
