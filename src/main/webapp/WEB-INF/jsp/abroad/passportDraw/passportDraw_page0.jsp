    ...
    <div class="col-xs-12">
        ...
        <div class="myTableDiv"
            ...
            <div class="table-container">
                <table style="min-width: 1900px" class="table table-actived table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th class="center">
                            <label class="pos-rel">
                    ...
                    <c:forEach items="${passportDraws}" var="passportDraw" varStatus="st">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${passportDraw.status!=PASSPORT_DRAW_STATUS_INIT}">
                                <button data-id="${passportDraw.id}" class="shortMsgBtn btn btn-warning btn-mini btn-xs">
                            ...
                            <td>
                                <button data-id="${passportDraw.id}" class="returnMsgBtn btn btn-danger btn-mini btn-xs">
