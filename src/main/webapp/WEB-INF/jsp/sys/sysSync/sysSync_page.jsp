...
<script>
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            { label: '类型', name: 'type', width: 200, formatter:function(cellvalue, options, rowObject){
            ...
            { label: '同步记录数', name: 'currentCount'},
            { label: '插入记录数', name: 'insertCount'},
            { label: '更新记录数', name: 'updateCount'},
