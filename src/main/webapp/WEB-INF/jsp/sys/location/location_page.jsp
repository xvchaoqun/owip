    ...
    $(function(){
        ...
        $("#treetable").fancytree({
            ...
            renderColumns: function(event, data) {
                ...
                $tdList.eq(2).html("<a class='btn btn-mini' onclick='_au("+node.data.id+")'><i class='fa fa-edit'></i> 编辑</a> &nbsp;&nbsp;" +
                "<a class='btn btn-mini btn-success' onclick='_appendChild("+node.data.code+")'><i class='fa fa-plus'></i> 添加子节点</a>&nbsp;&nbsp;" +
                "<a class='btn btn-mini btn-danger' onclick='_del("+node.data.id+")'><i class='fa fa-times'></i> 删除</a>");
            }
        });
    });
</script>