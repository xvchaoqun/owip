...
<div class="row">
    <div class="col-xs-12">
        ...
        <div id="body-content" class="myTableDiv"
            ...
            <c:set var="_query" value="${not empty param.unitType ||not empty param.year ||not empty param.workType ||not empty param.privacyType || not empty param.code || not empty param.sort}"/>
                <div class="tabbable">
                    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
                        <li  class="<c:if test="${status}">active</c:if>">
                            <a href="javascript:;" class="hashchange" data-querystr="status=1"><i class="fa fa-circle-o-notch fa-spin"></i> 有效执行文件</a>
                        </li>
                        <li  class="<c:if test="${!status}">active</c:if>">
                            <a href="javascript:;" class="hashchange" data-querystr="status=0"><i class="fa fa-history"></i> 失效作废文件</a>
                        </li>
                    </ul>
            ...
            <div class="jqgrid-vertical-offset buttons">
                <shiro:hasPermission name="dispatchWorkFile:edit">
                    ...
                    <a class="popupBtn btn btn-info btn-sm"
                       data-url="${ctx}/dispatchWorkFile_au?type=${param.type}"><i class="fa fa-plus"></i> 添加</a>
                    </c:if>
            ...
            <div class="jqgrid-vertical-offset widget-box ${_query?'':'collapsed'} hidden-sm hidden-xs">
                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        ...
                        <div class="form-group">
                            <label>保密级别</label>
                            <select data-rel="select2" name="privacyType" data-placeholder="请选择" data-width="270">
                                <option></option>
        ...
        colModel: [
            ...
            { label: '文件名',name: 'fileName'},
            {
                ...
                if (rowObject.filePath && rowObject.filePath != ''){
                    var fileName = rowObject.fileName || rowObject.id +"."+ (rowObject.filePath.substr(rowObject.filePath.indexOf(".")));
