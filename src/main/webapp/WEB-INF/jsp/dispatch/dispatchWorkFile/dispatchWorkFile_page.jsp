        ...
        colModel: [
            {label: '文件名', width: 420, name: 'fileName', align:'left', frozen: true},
            {
                ...
                if ($.trim(pdfFilePath) != '') {
                    ...
                    ret = '<button href="javascript:void(0)" data-width="900" data-url="${ctx}/pdf_preview?path={0}&filename={1}"  title="PDF文件预览" class="popupBtn btn btn-xs btn-primary" data-width="900"><i class="fa fa-search"></i> 预览</button>'
