...
<script>
    var colModel =  [
            ...
            { label:'新成立机构名称', name: 'unitId', width: 380, align:'left' ,formatter:function(cellvalue, options, rowObject){
            ...
            { label:'撤销机构名称', name: 'oldUnitId', width: 380, align:'left' ,formatter:function(cellvalue, options, rowObject){
                if(cellvalue==undefined) return '--'
                return (','+ rowObject.dispatch.category +',')
                    .indexOf(',<%=DispatchConstants.DISPATCH_CATEGORY_UNIT%>,')>=0?$.jgrid.formatter.unit(cellvalue)
                    :$.party(cellvalue);
