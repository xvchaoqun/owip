...
<%
    ...
    try {
        ...
        String sql = "select u.id from sys_user u, ow_member m where m.user_id=u.id and m.`status`!=1 and u.role_ids like '%,8,%'";
        rs = stat.executeQuery(sql);

        while (rs != null && rs.next()) {
            int userId = rs.getInt("id");
            sysUserService.delRole(userId, RoleConstants.ROLE_MEMBER);
        }
